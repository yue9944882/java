...
public interface V1NetworkPolicyEgressRuleFluent<A extends V1NetworkPolicyEgressRuleFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromTo(java.util.function.Predicate<V1NetworkPolicyPeerBuilder> predicate);
  ...
  public interface ToNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NetworkPolicyPeerFluent<V1NetworkPolicyEgressRuleFluent.ToNested<N>>{
    public N and();
    public N endTo();
