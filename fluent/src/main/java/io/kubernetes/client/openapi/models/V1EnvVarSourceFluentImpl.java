...
import java.lang.Object;
  ...
  */
  ...
  public A withFieldRef(io.kubernetes.client.openapi.models.V1ObjectFieldSelector fieldRef) {
    ...
    if (fieldRef!=null){ this.fieldRef= new V1ObjectFieldSelectorBuilder(fieldRef); _visitables.get("fieldRef").add(this.fieldRef);} return (A) this;
  }
  ...
  public A withResourceFieldRef(io.kubernetes.client.openapi.models.V1ResourceFieldSelector resourceFieldRef) {
    ...
    if (resourceFieldRef!=null){ this.resourceFieldRef= new V1ResourceFieldSelectorBuilder(resourceFieldRef); _visitables.get("resourceFieldRef").add(this.resourceFieldRef);} return (A) this;
  }
  ...
  class ConfigMapKeyRefNestedImpl<N> extends V1ConfigMapKeySelectorFluentImpl<V1EnvVarSourceFluent.ConfigMapKeyRefNested<N>> implements io.kubernetes.client.openapi.models.V1EnvVarSourceFluent.ConfigMapKeyRefNested<N>,Nested<N>{
  ...
  class FieldRefNestedImpl<N> extends V1ObjectFieldSelectorFluentImpl<V1EnvVarSourceFluent.FieldRefNested<N>> implements io.kubernetes.client.openapi.models.V1EnvVarSourceFluent.FieldRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceFieldRefNestedImpl<N> extends V1ResourceFieldSelectorFluentImpl<V1EnvVarSourceFluent.ResourceFieldRefNested<N>> implements io.kubernetes.client.openapi.models.V1EnvVarSourceFluent.ResourceFieldRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SecretKeyRefNestedImpl<N> extends V1SecretKeySelectorFluentImpl<V1EnvVarSourceFluent.SecretKeyRefNested<N>> implements io.kubernetes.client.openapi.models.V1EnvVarSourceFluent.SecretKeyRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
