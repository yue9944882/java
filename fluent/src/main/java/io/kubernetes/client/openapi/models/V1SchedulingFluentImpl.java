...
import java.util.Map;
  ...
  */
  ...
  class TolerationsNestedImpl<N> extends V1TolerationFluentImpl<V1SchedulingFluent.TolerationsNested<N>> implements io.kubernetes.client.openapi.models.V1SchedulingFluent.TolerationsNested<N>,Nested<N>{
