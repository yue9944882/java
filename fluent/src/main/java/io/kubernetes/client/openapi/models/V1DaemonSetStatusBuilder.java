...
public class V1DaemonSetStatusBuilder extends V1DaemonSetStatusFluentImpl<V1DaemonSetStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1DaemonSetStatus,io.kubernetes.client.openapi.models.V1DaemonSetStatusBuilder>{
