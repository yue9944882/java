...
import java.lang.Object;
  ...
  */
  ...
  public A withBehavior(io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBehavior behavior) {
    ...
    if (behavior!=null){ this.behavior= new V2beta2HorizontalPodAutoscalerBehaviorBuilder(behavior); _visitables.get("behavior").add(this.behavior);} return (A) this;
  }
  ...
  public A addToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2beta2MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<V2beta2MetricSpecBuilder>();}
  ...
  public A removeMatchingFromMetrics(Predicate<io.kubernetes.client.openapi.models.V2beta2MetricSpecBuilder> predicate) {
  ...
  class BehaviorNestedImpl<N> extends V2beta2HorizontalPodAutoscalerBehaviorFluentImpl<V2beta2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>,Nested<N>{
  ...
  class MetricsNestedImpl<N> extends V2beta2MetricSpecFluentImpl<V2beta2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ScaleTargetRefNestedImpl<N> extends V2beta2CrossVersionObjectReferenceFluentImpl<V2beta2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
