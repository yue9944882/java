...
import java.util.Map;
  ...
  */
  ...
  public A removeMatchingFromAllOf(Predicate<io.kubernetes.client.openapi.models.V1JSONSchemaPropsBuilder> predicate) {
  ...
  public A withExternalDocs(io.kubernetes.client.openapi.models.V1ExternalDocumentation externalDocs) {
    ...
    if (externalDocs!=null){ this.externalDocs= new V1ExternalDocumentationBuilder(externalDocs); _visitables.get("externalDocs").add(this.externalDocs);} return (A) this;
  }
  ...
  class AnyOfNestedImpl<N> extends V1JSONSchemaPropsFluentImpl<V1JSONSchemaPropsFluent.AnyOfNested<N>> implements V1JSONSchemaPropsFluent.AnyOfNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ExternalDocsNestedImpl<N> extends V1ExternalDocumentationFluentImpl<V1JSONSchemaPropsFluent.ExternalDocsNested<N>> implements io.kubernetes.client.openapi.models.V1JSONSchemaPropsFluent.ExternalDocsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class NotNestedImpl<N> extends V1JSONSchemaPropsFluentImpl<V1JSONSchemaPropsFluent.NotNested<N>> implements V1JSONSchemaPropsFluent.NotNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class OneOfNestedImpl<N> extends V1JSONSchemaPropsFluentImpl<V1JSONSchemaPropsFluent.OneOfNested<N>> implements V1JSONSchemaPropsFluent.OneOfNested<N>,io.kubernetes.client.fluent.Nested<N>{
