...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToPaths(Integer index,io.kubernetes.client.openapi.models.V1HTTPIngressPath item) {
    if (this.paths == null) {this.paths = new java.util.ArrayList<V1HTTPIngressPathBuilder>();}
  ...
  public A removeMatchingFromPaths(Predicate<io.kubernetes.client.openapi.models.V1HTTPIngressPathBuilder> predicate) {
  ...
  class PathsNestedImpl<N> extends V1HTTPIngressPathFluentImpl<V1HTTPIngressRuleValueFluent.PathsNested<N>> implements io.kubernetes.client.openapi.models.V1HTTPIngressRuleValueFluent.PathsNested<N>,Nested<N>{
