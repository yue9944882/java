...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CronJobSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1CronJobSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1CronJobStatus status) {
    ...
    if (status!=null){ this.status= new V1CronJobStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CronJobFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CronJobSpecFluentImpl<V1CronJobFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1CronJobStatusFluentImpl<V1CronJobFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
