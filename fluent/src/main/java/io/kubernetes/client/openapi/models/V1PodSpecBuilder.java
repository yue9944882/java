...
public class V1PodSpecBuilder extends V1PodSpecFluentImpl<V1PodSpecBuilder> implements VisitableBuilder<V1PodSpec,io.kubernetes.client.openapi.models.V1PodSpecBuilder>{
