...
import java.lang.Boolean;
  ...
  */
  ...
  public A withDeleteOptions(io.kubernetes.client.openapi.models.V1DeleteOptions deleteOptions) {
    ...
    if (deleteOptions!=null){ this.deleteOptions= new V1DeleteOptionsBuilder(deleteOptions); _visitables.get("deleteOptions").add(this.deleteOptions);} return (A) this;
  }
  ...
  class DeleteOptionsNestedImpl<N> extends V1DeleteOptionsFluentImpl<V1EvictionFluent.DeleteOptionsNested<N>> implements io.kubernetes.client.openapi.models.V1EvictionFluent.DeleteOptionsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1EvictionFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1EvictionFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
