...
import java.lang.Boolean;
  ...
  */
  ...
  public A withService(io.kubernetes.client.openapi.models.V1IngressServiceBackend service) {
    ...
    if (service!=null){ this.service= new V1IngressServiceBackendBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
  }
  ...
  class ResourceNestedImpl<N> extends V1TypedLocalObjectReferenceFluentImpl<V1IngressBackendFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V1IngressBackendFluent.ResourceNested<N>,Nested<N>{
  ...
  class ServiceNestedImpl<N> extends V1IngressServiceBackendFluentImpl<V1IngressBackendFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.V1IngressBackendFluent.ServiceNested<N>,io.kubernetes.client.fluent.Nested<N>{
