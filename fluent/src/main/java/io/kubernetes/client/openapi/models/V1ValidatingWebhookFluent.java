...
public interface V1ValidatingWebhookFluent<A extends V1ValidatingWebhookFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromRules(java.util.function.Predicate<V1RuleWithOperationsBuilder> predicate);
  ...
  public interface NamespaceSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1ValidatingWebhookFluent.NamespaceSelectorNested<N>>{
    public N and();
    public N endNamespaceSelector();
    
  }
  public interface ObjectSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1ValidatingWebhookFluent.ObjectSelectorNested<N>>{
    public N and();
    public N endObjectSelector();
    
  }
  public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1RuleWithOperationsFluent<V1ValidatingWebhookFluent.RulesNested<N>>{
    public N and();
    public N endRule();
