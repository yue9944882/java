...
import java.lang.Boolean;
  ...
  */
  ...
  private V1HTTPGetAction.SchemeEnum scheme;
  ...
  public A addToHttpHeaders(Integer index,io.kubernetes.client.openapi.models.V1HTTPHeader item) {
    if (this.httpHeaders == null) {this.httpHeaders = new java.util.ArrayList<V1HTTPHeaderBuilder>();}
  ...
  public A removeMatchingFromHttpHeaders(Predicate<io.kubernetes.client.openapi.models.V1HTTPHeaderBuilder> predicate) {
  ...
  class HttpHeadersNestedImpl<N> extends V1HTTPHeaderFluentImpl<V1HTTPGetActionFluent.HttpHeadersNested<N>> implements io.kubernetes.client.openapi.models.V1HTTPGetActionFluent.HttpHeadersNested<N>,Nested<N>{
