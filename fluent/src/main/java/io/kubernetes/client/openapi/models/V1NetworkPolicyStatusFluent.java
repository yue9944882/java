...
public class V1NetworkPolicyStatusFluent<A extends V1NetworkPolicyStatusFluent<A>> extends BaseFluent<A>{
  public V1NetworkPolicyStatusFluent() {
  }
  
  public V1NetworkPolicyStatusFluent(V1NetworkPolicyStatus instance) {
    this.copyInstance(instance);
  }
  private ArrayList<V1ConditionBuilder> conditions;
  
  protected void copyInstance(V1NetworkPolicyStatus instance) {
    instance = (instance != null ? instance : new V1NetworkPolicyStatus());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    V1NetworkPolicyStatusFluent that = (V1NetworkPolicyStatusFluent) o;
  ...
  public class ConditionsNested<N> extends V1ConditionFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) V1NetworkPolicyStatusFluent.this.setToConditions(index,builder.build());
    }
