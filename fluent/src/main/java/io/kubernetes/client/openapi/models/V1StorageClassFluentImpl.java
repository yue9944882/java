...
import java.util.Map;
  ...
  */
  ...
  public A addAllToAllowedTopologies(Collection<io.kubernetes.client.openapi.models.V1TopologySelectorTerm> items) {
    if (this.allowedTopologies == null) {this.allowedTopologies = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder>();}
    for (io.kubernetes.client.openapi.models.V1TopologySelectorTerm item : items) {io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder builder = new io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder(item);_visitables.get("allowedTopologies").add(builder);this.allowedTopologies.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromAllowedTopologies(Predicate<io.kubernetes.client.openapi.models.V1TopologySelectorTermBuilder> predicate) {
  ...
  class AllowedTopologiesNestedImpl<N> extends V1TopologySelectorTermFluentImpl<V1StorageClassFluent.AllowedTopologiesNested<N>> implements io.kubernetes.client.openapi.models.V1StorageClassFluent.AllowedTopologiesNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1StorageClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1StorageClassFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
