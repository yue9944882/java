...
import java.lang.Boolean;
  ...
  */
  ...
  public A withBackend(io.kubernetes.client.openapi.models.V1IngressBackend backend) {
    ...
    if (backend!=null){ this.backend= new V1IngressBackendBuilder(backend); _visitables.get("backend").add(this.backend);} return (A) this;
  }
  ...
  class BackendNestedImpl<N> extends V1IngressBackendFluentImpl<V1HTTPIngressPathFluent.BackendNested<N>> implements io.kubernetes.client.openapi.models.V1HTTPIngressPathFluent.BackendNested<N>,Nested<N>{
