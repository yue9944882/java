...
public interface AuthenticationV1TokenRequestFluent<A extends AuthenticationV1TokenRequestFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TokenRequestSpecFluent<AuthenticationV1TokenRequestFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TokenRequestStatusFluent<AuthenticationV1TokenRequestFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
