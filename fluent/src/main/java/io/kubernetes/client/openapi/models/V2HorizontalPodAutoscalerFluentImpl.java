...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerStatus status) {
    ...
    if (status!=null){ this.status= new V2HorizontalPodAutoscalerStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V2HorizontalPodAutoscalerFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V2HorizontalPodAutoscalerSpecFluentImpl<V2HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V2HorizontalPodAutoscalerStatusFluentImpl<V2HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
