...
public interface V2beta2HorizontalPodAutoscalerSpecFluent<A extends V2beta2HorizontalPodAutoscalerSpecFluent<A>> extends Fluent<A>{
  ...
  public interface MetricsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricSpecFluent<V2beta2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>>{
    public N and();
    public N endMetric();
    
  }
  public interface ScaleTargetRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2CrossVersionObjectReferenceFluent<V2beta2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>>{
    public N and();
