...
public class V1PersistentVolumeClaimConditionBuilder extends V1PersistentVolumeClaimConditionFluentImpl<V1PersistentVolumeClaimConditionBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimCondition,io.kubernetes.client.openapi.models.V1PersistentVolumeClaimConditionBuilder>{
