...
public interface V1EndpointFluent<A extends V1EndpointFluent<A>> extends Fluent<A>{
  ...
  public interface HintsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1EndpointHintsFluent<V1EndpointFluent.HintsNested<N>>{
    public N and();
    public N endHints();
    
  }
  public interface TargetRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectReferenceFluent<V1EndpointFluent.TargetRefNested<N>>{
    public N and();
