...
public interface V1alpha1StorageVersionStatusFluent<A extends V1alpha1StorageVersionStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromStorageVersions(java.util.function.Predicate<V1alpha1ServerStorageVersionBuilder> predicate);
  ...
  public interface StorageVersionsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1alpha1ServerStorageVersionFluent<V1alpha1StorageVersionStatusFluent.StorageVersionsNested<N>>{
    public N and();
