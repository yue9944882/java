...
public class V1PodReadinessGateBuilder extends V1PodReadinessGateFluentImpl<V1PodReadinessGateBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1PodReadinessGate,V1PodReadinessGateBuilder>{
