...
public interface V1EnvVarSourceFluent<A extends V1EnvVarSourceFluent<A>> extends Fluent<A>{
  ...
  public interface FieldRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectFieldSelectorFluent<V1EnvVarSourceFluent.FieldRefNested<N>>{
    public N and();
    public N endFieldRef();
    
  }
  public interface ResourceFieldRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ResourceFieldSelectorFluent<V1EnvVarSourceFluent.ResourceFieldRefNested<N>>{
    public N and();
    public N endResourceFieldRef();
    
  }
  public interface SecretKeyRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SecretKeySelectorFluent<V1EnvVarSourceFluent.SecretKeyRefNested<N>>{
    public N and();
