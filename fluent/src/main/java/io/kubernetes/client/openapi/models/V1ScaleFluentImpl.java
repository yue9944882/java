...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1ScaleStatus status) {
    ...
    if (status!=null){ this.status= new V1ScaleStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ScaleFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ScaleSpecFluentImpl<V1ScaleFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ScaleStatusFluentImpl<V1ScaleFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ScaleFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
