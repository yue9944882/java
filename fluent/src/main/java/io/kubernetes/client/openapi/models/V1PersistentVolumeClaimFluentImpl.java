...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1PersistentVolumeClaimSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1PersistentVolumeClaimSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1PersistentVolumeClaimFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1PersistentVolumeClaimSpecFluentImpl<V1PersistentVolumeClaimFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1PersistentVolumeClaimStatusFluentImpl<V1PersistentVolumeClaimFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
