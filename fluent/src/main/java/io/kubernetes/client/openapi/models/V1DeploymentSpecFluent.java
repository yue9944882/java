...
public interface V1DeploymentSpecFluent<A extends V1DeploymentSpecFluent<A>> extends Fluent<A>{
  ...
  public interface StrategyNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1DeploymentStrategyFluent<V1DeploymentSpecFluent.StrategyNested<N>>{
    public N and();
    public N endStrategy();
    
  }
  public interface TemplateNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodTemplateSpecFluent<V1DeploymentSpecFluent.TemplateNested<N>>{
    public N and();
