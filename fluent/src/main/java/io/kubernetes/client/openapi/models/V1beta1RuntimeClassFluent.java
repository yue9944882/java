...
public interface V1beta1RuntimeClassFluent<A extends V1beta1RuntimeClassFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V1beta1RuntimeClassFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface OverheadNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1OverheadFluent<V1beta1RuntimeClassFluent.OverheadNested<N>>{
    public N and();
    public N endOverhead();
    
  }
  public interface SchedulingNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1SchedulingFluent<V1beta1RuntimeClassFluent.SchedulingNested<N>>{
    public N and();
