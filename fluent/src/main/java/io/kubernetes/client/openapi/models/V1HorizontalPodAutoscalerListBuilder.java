...
public class V1HorizontalPodAutoscalerListBuilder extends V1HorizontalPodAutoscalerListFluentImpl<V1HorizontalPodAutoscalerListBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerList,V1HorizontalPodAutoscalerListBuilder>{
