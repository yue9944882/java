...
public class V1PodDNSConfigBuilder extends V1PodDNSConfigFluentImpl<V1PodDNSConfigBuilder> implements VisitableBuilder<V1PodDNSConfig,io.kubernetes.client.openapi.models.V1PodDNSConfigBuilder>{
