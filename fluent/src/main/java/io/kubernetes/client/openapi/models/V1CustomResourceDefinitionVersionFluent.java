...
public interface V1CustomResourceDefinitionVersionFluent<A extends V1CustomResourceDefinitionVersionFluent<A>> extends Fluent<A>{
  ...
  public Boolean hasMatchingAdditionalPrinterColumn(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> predicate);
  ...
  public interface SchemaNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CustomResourceValidationFluent<V1CustomResourceDefinitionVersionFluent.SchemaNested<N>>{
    public N and();
    public N endSchema();
    
  }
  public interface SubresourcesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CustomResourceSubresourcesFluent<V1CustomResourceDefinitionVersionFluent.SubresourcesNested<N>>{
    public N and();
