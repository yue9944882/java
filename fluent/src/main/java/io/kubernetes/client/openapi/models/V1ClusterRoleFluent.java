...
public interface V1ClusterRoleFluent<A extends V1ClusterRoleFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectMetaFluent<V1ClusterRoleFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PolicyRuleFluent<V1ClusterRoleFluent.RulesNested<N>>{
    public N and();
    public N endRule();
