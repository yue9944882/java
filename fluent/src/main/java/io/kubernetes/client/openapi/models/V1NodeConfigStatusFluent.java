...
public interface V1NodeConfigStatusFluent<A extends V1NodeConfigStatusFluent<A>> extends Fluent<A>{
  ...
  public interface AssignedNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NodeConfigSourceFluent<V1NodeConfigStatusFluent.AssignedNested<N>>{
    public N and();
    public N endAssigned();
    
  }
  public interface LastKnownGoodNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NodeConfigSourceFluent<V1NodeConfigStatusFluent.LastKnownGoodNested<N>>{
    public N and();
