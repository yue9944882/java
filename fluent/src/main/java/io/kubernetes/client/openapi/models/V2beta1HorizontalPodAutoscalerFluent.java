...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V2beta1HorizontalPodAutoscalerFluent<A extends V2beta1HorizontalPodAutoscalerFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V2beta1HorizontalPodAutoscalerFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1HorizontalPodAutoscalerSpecFluent<V2beta1HorizontalPodAutoscalerFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1HorizontalPodAutoscalerStatusFluent<V2beta1HorizontalPodAutoscalerFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
