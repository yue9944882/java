...
public class V1PodDisruptionBudgetStatusBuilder extends V1PodDisruptionBudgetStatusFluentImpl<V1PodDisruptionBudgetStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatus,V1PodDisruptionBudgetStatusBuilder>{
