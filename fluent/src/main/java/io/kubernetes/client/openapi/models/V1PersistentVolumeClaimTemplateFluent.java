...
public interface V1PersistentVolumeClaimTemplateFluent<A extends V1PersistentVolumeClaimTemplateFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PersistentVolumeClaimSpecFluent<V1PersistentVolumeClaimTemplateFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
