...
public interface V1beta1CronJobFluent<A extends V1beta1CronJobFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V1beta1CronJobFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1CronJobSpecFluent<V1beta1CronJobFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1CronJobStatusFluent<V1beta1CronJobFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
