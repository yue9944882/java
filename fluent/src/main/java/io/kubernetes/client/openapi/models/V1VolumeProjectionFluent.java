...
public interface V1VolumeProjectionFluent<A extends V1VolumeProjectionFluent<A>> extends Fluent<A>{
  ...
  public interface DownwardAPINested<N> extends io.kubernetes.client.fluent.Nested<N>,V1DownwardAPIProjectionFluent<V1VolumeProjectionFluent.DownwardAPINested<N>>{
    public N and();
    public N endDownwardAPI();
    
  }
  public interface SecretNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SecretProjectionFluent<V1VolumeProjectionFluent.SecretNested<N>>{
    public N and();
    public N endSecret();
    
  }
  public interface ServiceAccountTokenNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ServiceAccountTokenProjectionFluent<V1VolumeProjectionFluent.ServiceAccountTokenNested<N>>{
    public N and();
