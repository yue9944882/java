...
public interface EventsV1EventFluent<A extends EventsV1EventFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectMetaFluent<EventsV1EventFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface RegardingNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectReferenceFluent<EventsV1EventFluent.RegardingNested<N>>{
    public N and();
    public N endRegarding();
    
  }
  public interface RelatedNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectReferenceFluent<EventsV1EventFluent.RelatedNested<N>>{
    public N and();
    public N endRelated();
    
  }
  public interface SeriesNested<N> extends io.kubernetes.client.fluent.Nested<N>,EventsV1EventSeriesFluent<EventsV1EventFluent.SeriesNested<N>>{
    public N and();
    public N endSeries();
