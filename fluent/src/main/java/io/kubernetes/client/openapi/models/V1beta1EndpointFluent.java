...
public interface V1beta1EndpointFluent<A extends V1beta1EndpointFluent<A>> extends Fluent<A>{
  ...
  public interface ConditionsNested<N> extends Nested<N>,V1beta1EndpointConditionsFluent<V1beta1EndpointFluent.ConditionsNested<N>>{
    public N and();
    public N endConditions();
    
  }
  public interface HintsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1EndpointHintsFluent<V1beta1EndpointFluent.HintsNested<N>>{
    public N and();
    public N endHints();
