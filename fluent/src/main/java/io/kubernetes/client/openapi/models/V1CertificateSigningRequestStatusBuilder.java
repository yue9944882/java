...
public class V1CertificateSigningRequestStatusBuilder extends V1CertificateSigningRequestStatusFluentImpl<V1CertificateSigningRequestStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatus,io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatusBuilder>{
