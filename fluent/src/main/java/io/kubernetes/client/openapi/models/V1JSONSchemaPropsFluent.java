...
public interface V1JSONSchemaPropsFluent<A extends V1JSONSchemaPropsFluent<A>> extends Fluent<A>{
   ...
   */
  @Deprecated
  public List<io.kubernetes.client.openapi.models.V1JSONSchemaProps> getAllOf();
  ...
  public A addToDefinitions(Map<java.lang.String,io.kubernetes.client.openapi.models.V1JSONSchemaProps> map);
  ...
  public interface AnyOfNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JSONSchemaPropsFluent<V1JSONSchemaPropsFluent.AnyOfNested<N>>{
    public N and();
    public N endAnyOf();
    
  }
  public interface ExternalDocsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ExternalDocumentationFluent<V1JSONSchemaPropsFluent.ExternalDocsNested<N>>{
    public N and();
    public N endExternalDocs();
    
  }
  public interface NotNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JSONSchemaPropsFluent<V1JSONSchemaPropsFluent.NotNested<N>>{
    public N and();
    public N endNot();
    
  }
  public interface OneOfNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JSONSchemaPropsFluent<V1JSONSchemaPropsFluent.OneOfNested<N>>{
    public N and();
    public N endOneOf();
