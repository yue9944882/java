...
public interface CoreV1EventFluent<A extends CoreV1EventFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectMetaFluent<CoreV1EventFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface RelatedNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectReferenceFluent<CoreV1EventFluent.RelatedNested<N>>{
    public N and();
    public N endRelated();
    
  }
  public interface SeriesNested<N> extends io.kubernetes.client.fluent.Nested<N>,CoreV1EventSeriesFluent<CoreV1EventFluent.SeriesNested<N>>{
    public N and();
    public N endSeries();
    
  }
  public interface SourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1EventSourceFluent<CoreV1EventFluent.SourceNested<N>>{
    public N and();
    public N endSource();
