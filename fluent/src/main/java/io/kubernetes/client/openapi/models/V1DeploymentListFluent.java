...
public interface V1DeploymentListFluent<A extends V1DeploymentListFluent<A>> extends Fluent<A>{
  ...
  public V1DeploymentListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1Deployment item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1DeploymentListFluent.MetadataNested<N>>{
    public N and();
