...
public interface V1PersistentVolumeClaimStatusFluent<A extends V1PersistentVolumeClaimStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<V1PersistentVolumeClaimConditionBuilder> predicate);
  ...
  public V1PersistentVolumeClaimStatus.PhaseEnum getPhase();
