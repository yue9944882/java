...
public interface V1NodeStatusFluent<A extends V1NodeStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromConditions(java.util.function.Predicate<V1NodeConditionBuilder> predicate);
  ...
  public A removeMatchingFromImages(java.util.function.Predicate<V1ContainerImageBuilder> predicate);
  ...
  public V1NodeStatus.PhaseEnum getPhase();
  ...
  public A removeMatchingFromVolumesAttached(java.util.function.Predicate<V1AttachedVolumeBuilder> predicate);
