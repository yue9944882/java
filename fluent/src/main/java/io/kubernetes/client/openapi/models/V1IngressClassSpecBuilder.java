...
public class V1IngressClassSpecBuilder extends V1IngressClassSpecFluentImpl<V1IngressClassSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1IngressClassSpec,io.kubernetes.client.openapi.models.V1IngressClassSpecBuilder>{
