...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1VolumeAttachmentStatus status) {
    ...
    if (status!=null){ this.status= new V1VolumeAttachmentStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1VolumeAttachmentFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeAttachmentFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1VolumeAttachmentSpecFluentImpl<V1VolumeAttachmentFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeAttachmentFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1VolumeAttachmentStatusFluentImpl<V1VolumeAttachmentFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeAttachmentFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
