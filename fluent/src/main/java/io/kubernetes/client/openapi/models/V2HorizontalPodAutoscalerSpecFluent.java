...
public interface V2HorizontalPodAutoscalerSpecFluent<A extends V2HorizontalPodAutoscalerSpecFluent<A>> extends Fluent<A>{
  ...
  public interface MetricsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2MetricSpecFluent<V2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>>{
    public N and();
    public N endMetric();
    
  }
  public interface ScaleTargetRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2CrossVersionObjectReferenceFluent<V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>>{
    public N and();
