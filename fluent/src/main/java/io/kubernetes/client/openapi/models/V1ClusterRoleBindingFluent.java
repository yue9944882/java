...
public interface V1ClusterRoleBindingFluent<A extends V1ClusterRoleBindingFluent<A>> extends Fluent<A>{
  ...
  public interface RoleRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1RoleRefFluent<V1ClusterRoleBindingFluent.RoleRefNested<N>>{
    public N and();
    public N endRoleRef();
    
  }
  public interface SubjectsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SubjectFluent<V1ClusterRoleBindingFluent.SubjectsNested<N>>{
    public N and();
    public N endSubject();
