...
import java.util.Map;
  ...
  */
  ...
  public A addToMatchExpressions(Integer index,io.kubernetes.client.openapi.models.V1LabelSelectorRequirement item) {
    if (this.matchExpressions == null) {this.matchExpressions = new java.util.ArrayList<V1LabelSelectorRequirementBuilder>();}
  ...
  public A addAllToMatchExpressions(Collection<io.kubernetes.client.openapi.models.V1LabelSelectorRequirement> items) {
    if (this.matchExpressions == null) {this.matchExpressions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LabelSelectorRequirementBuilder>();}
    for (io.kubernetes.client.openapi.models.V1LabelSelectorRequirement item : items) {io.kubernetes.client.openapi.models.V1LabelSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1LabelSelectorRequirementBuilder(item);_visitables.get("matchExpressions").add(builder);this.matchExpressions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromMatchExpressions(Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorRequirementBuilder> predicate) {
  ...
  public Boolean hasMatchingMatchExpression(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorRequirementBuilder> predicate) {
  ...
  class MatchExpressionsNestedImpl<N> extends V1LabelSelectorRequirementFluentImpl<V1LabelSelectorFluent.MatchExpressionsNested<N>> implements io.kubernetes.client.openapi.models.V1LabelSelectorFluent.MatchExpressionsNested<N>,Nested<N>{
