...
public interface V1LocalSubjectAccessReviewFluent<A extends V1LocalSubjectAccessReviewFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SubjectAccessReviewSpecFluent<V1LocalSubjectAccessReviewFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SubjectAccessReviewStatusFluent<V1LocalSubjectAccessReviewFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
