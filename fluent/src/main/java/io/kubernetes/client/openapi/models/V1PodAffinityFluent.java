...
public interface V1PodAffinityFluent<A extends V1PodAffinityFluent<A>> extends Fluent<A>{
  ...
  public interface RequiredDuringSchedulingIgnoredDuringExecutionNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodAffinityTermFluent<V1PodAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<N>>{
    public N and();
