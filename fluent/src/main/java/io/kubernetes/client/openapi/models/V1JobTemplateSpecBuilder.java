...
public class V1JobTemplateSpecBuilder extends V1JobTemplateSpecFluentImpl<V1JobTemplateSpecBuilder> implements VisitableBuilder<V1JobTemplateSpec,io.kubernetes.client.openapi.models.V1JobTemplateSpecBuilder>{
