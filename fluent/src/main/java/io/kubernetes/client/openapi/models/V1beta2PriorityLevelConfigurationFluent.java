...
public interface V1beta2PriorityLevelConfigurationFluent<A extends V1beta2PriorityLevelConfigurationFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta2PriorityLevelConfigurationSpecFluent<V1beta2PriorityLevelConfigurationFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta2PriorityLevelConfigurationStatusFluent<V1beta2PriorityLevelConfigurationFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
