...
import java.lang.Object;
  ...
  */
  ...
  public A withCapabilities(io.kubernetes.client.openapi.models.V1Capabilities capabilities) {
    ...
    if (capabilities!=null){ this.capabilities= new V1CapabilitiesBuilder(capabilities); _visitables.get("capabilities").add(this.capabilities);} return (A) this;
  }
  ...
  public A withSeccompProfile(io.kubernetes.client.openapi.models.V1SeccompProfile seccompProfile) {
    ...
    if (seccompProfile!=null){ this.seccompProfile= new V1SeccompProfileBuilder(seccompProfile); _visitables.get("seccompProfile").add(this.seccompProfile);} return (A) this;
  }
  ...
  class CapabilitiesNestedImpl<N> extends V1CapabilitiesFluentImpl<V1SecurityContextFluent.CapabilitiesNested<N>> implements io.kubernetes.client.openapi.models.V1SecurityContextFluent.CapabilitiesNested<N>,Nested<N>{
  ...
  class SeLinuxOptionsNestedImpl<N> extends V1SELinuxOptionsFluentImpl<V1SecurityContextFluent.SeLinuxOptionsNested<N>> implements io.kubernetes.client.openapi.models.V1SecurityContextFluent.SeLinuxOptionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SeccompProfileNestedImpl<N> extends V1SeccompProfileFluentImpl<V1SecurityContextFluent.SeccompProfileNested<N>> implements io.kubernetes.client.openapi.models.V1SecurityContextFluent.SeccompProfileNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class WindowsOptionsNestedImpl<N> extends V1WindowsSecurityContextOptionsFluentImpl<V1SecurityContextFluent.WindowsOptionsNested<N>> implements io.kubernetes.client.openapi.models.V1SecurityContextFluent.WindowsOptionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
