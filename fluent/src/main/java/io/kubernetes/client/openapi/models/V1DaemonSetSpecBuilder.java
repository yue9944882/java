...
public class V1DaemonSetSpecBuilder extends V1DaemonSetSpecFluentImpl<V1DaemonSetSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1DaemonSetSpec,V1DaemonSetSpecBuilder>{
