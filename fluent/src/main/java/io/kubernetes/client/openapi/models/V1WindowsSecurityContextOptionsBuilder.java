...
public class V1WindowsSecurityContextOptionsBuilder extends V1WindowsSecurityContextOptionsFluentImpl<V1WindowsSecurityContextOptionsBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1WindowsSecurityContextOptions,V1WindowsSecurityContextOptionsBuilder>{
