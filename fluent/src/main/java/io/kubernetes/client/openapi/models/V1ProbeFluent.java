...
public interface V1ProbeFluent<A extends V1ProbeFluent<A>> extends Fluent<A>{
  ...
  public interface GrpcNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1GRPCActionFluent<V1ProbeFluent.GrpcNested<N>>{
    public N and();
    public N endGrpc();
    
  }
  public interface HttpGetNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1HTTPGetActionFluent<V1ProbeFluent.HttpGetNested<N>>{
    public N and();
    public N endHttpGet();
    
  }
  public interface TcpSocketNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TCPSocketActionFluent<V1ProbeFluent.TcpSocketNested<N>>{
    public N and();
