...
public interface V1alpha1RuntimeClassSpecFluent<A extends V1alpha1RuntimeClassSpecFluent<A>> extends Fluent<A>{
  ...
  public interface OverheadNested<N> extends Nested<N>,V1alpha1OverheadFluent<V1alpha1RuntimeClassSpecFluent.OverheadNested<N>>{
    public N and();
    public N endOverhead();
    
  }
  public interface SchedulingNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1alpha1SchedulingFluent<V1alpha1RuntimeClassSpecFluent.SchedulingNested<N>>{
    public N and();
