...
public class V1NetworkPolicyListBuilder extends V1NetworkPolicyListFluentImpl<V1NetworkPolicyListBuilder> implements VisitableBuilder<V1NetworkPolicyList,io.kubernetes.client.openapi.models.V1NetworkPolicyListBuilder>{
