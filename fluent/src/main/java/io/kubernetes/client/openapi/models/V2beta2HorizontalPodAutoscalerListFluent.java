...
public interface V2beta2HorizontalPodAutoscalerListFluent<A extends V2beta2HorizontalPodAutoscalerListFluent<A>> extends Fluent<A>{
  ...
  public V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V2beta2HorizontalPodAutoscalerListFluent.MetadataNested<N>>{
    public N and();
