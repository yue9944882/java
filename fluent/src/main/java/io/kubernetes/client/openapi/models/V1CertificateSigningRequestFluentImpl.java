...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CertificateSigningRequestSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1CertificateSigningRequestSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1CertificateSigningRequestStatus status) {
    ...
    if (status!=null){ this.status= new V1CertificateSigningRequestStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CertificateSigningRequestFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CertificateSigningRequestSpecFluentImpl<V1CertificateSigningRequestFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1CertificateSigningRequestStatusFluentImpl<V1CertificateSigningRequestFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1CertificateSigningRequestFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
