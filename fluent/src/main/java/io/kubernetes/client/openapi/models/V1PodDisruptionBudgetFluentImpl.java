...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1PodDisruptionBudgetStatus status) {
    ...
    if (status!=null){ this.status= new V1PodDisruptionBudgetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1PodDisruptionBudgetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1PodDisruptionBudgetSpecFluentImpl<V1PodDisruptionBudgetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1PodDisruptionBudgetStatusFluentImpl<V1PodDisruptionBudgetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PodDisruptionBudgetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
