...
import java.util.Map;
  ...
  */
  ...
  class AttachErrorNestedImpl<N> extends V1VolumeErrorFluentImpl<V1VolumeAttachmentStatusFluent.AttachErrorNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeAttachmentStatusFluent.AttachErrorNested<N>,Nested<N>{
  ...
  class DetachErrorNestedImpl<N> extends V1VolumeErrorFluentImpl<V1VolumeAttachmentStatusFluent.DetachErrorNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeAttachmentStatusFluent.DetachErrorNested<N>,io.kubernetes.client.fluent.Nested<N>{
