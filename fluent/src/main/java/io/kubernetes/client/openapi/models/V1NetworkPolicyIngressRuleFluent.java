...
public interface V1NetworkPolicyIngressRuleFluent<A extends V1NetworkPolicyIngressRuleFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromPorts(java.util.function.Predicate<V1NetworkPolicyPortBuilder> predicate);
  ...
  public interface PortsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NetworkPolicyPortFluent<V1NetworkPolicyIngressRuleFluent.PortsNested<N>>{
    public N and();
    public N endPort();
