...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1CSINodeBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V1CSINodeFluentImpl<V1CSINodeListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1CSINodeListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
