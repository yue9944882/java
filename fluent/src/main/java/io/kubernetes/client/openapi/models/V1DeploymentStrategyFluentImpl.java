...
import java.lang.Boolean;
  ...
  */
  ...
  private V1DeploymentStrategy.TypeEnum type;
  ...
  public A withRollingUpdate(io.kubernetes.client.openapi.models.V1RollingUpdateDeployment rollingUpdate) {
    ...
    if (rollingUpdate!=null){ this.rollingUpdate= new V1RollingUpdateDeploymentBuilder(rollingUpdate); _visitables.get("rollingUpdate").add(this.rollingUpdate);} return (A) this;
  }
  ...
  class RollingUpdateNestedImpl<N> extends V1RollingUpdateDeploymentFluentImpl<V1DeploymentStrategyFluent.RollingUpdateNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentStrategyFluent.RollingUpdateNested<N>,Nested<N>{
