...
import java.lang.Boolean;
  ...
  */
  ...
  public A withLimited(io.kubernetes.client.openapi.models.V1beta2LimitedPriorityLevelConfiguration limited) {
    ...
    if (limited!=null){ this.limited= new V1beta2LimitedPriorityLevelConfigurationBuilder(limited); _visitables.get("limited").add(this.limited);} return (A) this;
  }
  ...
  class LimitedNestedImpl<N> extends V1beta2LimitedPriorityLevelConfigurationFluentImpl<V1beta2PriorityLevelConfigurationSpecFluent.LimitedNested<N>> implements io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationSpecFluent.LimitedNested<N>,Nested<N>{
