...
import java.lang.Object;
  ...
  */
  ...
  public A withObject(io.kubernetes.client.openapi.models.V2ObjectMetricSource _object) {
    ...
    if (_object!=null){ this._object= new V2ObjectMetricSourceBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
  }
  ...
  public A withResource(io.kubernetes.client.openapi.models.V2ResourceMetricSource resource) {
    ...
    if (resource!=null){ this.resource= new V2ResourceMetricSourceBuilder(resource); _visitables.get("resource").add(this.resource);} return (A) this;
  }
  ...
  class ContainerResourceNestedImpl<N> extends V2ContainerResourceMetricSourceFluentImpl<V2MetricSpecFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2ExternalMetricSourceFluentImpl<V2MetricSpecFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2ObjectMetricSourceFluentImpl<V2MetricSpecFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2PodsMetricSourceFluentImpl<V2MetricSpecFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2ResourceMetricSourceFluentImpl<V2MetricSpecFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricSpecFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
