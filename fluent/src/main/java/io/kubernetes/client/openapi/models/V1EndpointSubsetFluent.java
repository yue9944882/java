...
public interface V1EndpointSubsetFluent<A extends V1EndpointSubsetFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromPorts(java.util.function.Predicate<CoreV1EndpointPortBuilder> predicate);
  ...
  public interface NotReadyAddressesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1EndpointAddressFluent<V1EndpointSubsetFluent.NotReadyAddressesNested<N>>{
    public N and();
    public N endNotReadyAddress();
    
  }
  public interface PortsNested<N> extends io.kubernetes.client.fluent.Nested<N>,CoreV1EndpointPortFluent<V1EndpointSubsetFluent.PortsNested<N>>{
    public N and();
    public N endPort();
