...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToOptions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PodDNSConfigOption item) {
    if (this.options == null) {this.options = new java.util.ArrayList<V1PodDNSConfigOptionBuilder>();}
  ...
  class OptionsNestedImpl<N> extends V1PodDNSConfigOptionFluentImpl<V1PodDNSConfigFluent.OptionsNested<N>> implements io.kubernetes.client.openapi.models.V1PodDNSConfigFluent.OptionsNested<N>,Nested<N>{
