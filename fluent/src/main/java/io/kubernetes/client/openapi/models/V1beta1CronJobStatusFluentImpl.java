...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToActive(Integer index,io.kubernetes.client.openapi.models.V1ObjectReference item) {
    if (this.active == null) {this.active = new java.util.ArrayList<V1ObjectReferenceBuilder>();}
  ...
  public A removeMatchingFromActive(Predicate<io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder> predicate) {
  ...
  public Boolean hasMatchingActive(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1ObjectReferenceBuilder> predicate) {
  ...
  class ActiveNestedImpl<N> extends V1ObjectReferenceFluentImpl<V1beta1CronJobStatusFluent.ActiveNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobStatusFluent.ActiveNested<N>,Nested<N>{
