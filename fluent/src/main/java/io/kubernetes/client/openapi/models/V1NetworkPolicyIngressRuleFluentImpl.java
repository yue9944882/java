...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromFrom(Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> predicate) {
  ...
  public Boolean hasMatchingFrom(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPeerBuilder> predicate) {
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<V1NetworkPolicyPortBuilder>();}
  ...
  class FromNestedImpl<N> extends V1NetworkPolicyPeerFluentImpl<V1NetworkPolicyIngressRuleFluent.FromNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyIngressRuleFluent.FromNested<N>,Nested<N>{
  ...
  class PortsNestedImpl<N> extends V1NetworkPolicyPortFluentImpl<V1NetworkPolicyIngressRuleFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyIngressRuleFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
