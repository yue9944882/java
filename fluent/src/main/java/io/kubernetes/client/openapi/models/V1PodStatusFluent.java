...
public interface V1PodStatusFluent<A extends V1PodStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromContainerStatuses(java.util.function.Predicate<V1ContainerStatusBuilder> predicate);
  ...
  public V1PodStatus.PhaseEnum getPhase();
  ...
  public V1PodStatus.QosClassEnum getQosClass();
  ...
  public interface EphemeralContainerStatusesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ContainerStatusFluent<V1PodStatusFluent.EphemeralContainerStatusesNested<N>>{
    public N and();
  ...
  public interface PodIPsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodIPFluent<V1PodStatusFluent.PodIPsNested<N>>{
    public N and();
    public N endPodIP();
