...
public class V1AffinityBuilder extends V1AffinityFluentImpl<V1AffinityBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1Affinity,V1AffinityBuilder>{
