...
public interface V1APIServiceFluent<A extends V1APIServiceFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1APIServiceSpecFluent<V1APIServiceFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1APIServiceStatusFluent<V1APIServiceFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
