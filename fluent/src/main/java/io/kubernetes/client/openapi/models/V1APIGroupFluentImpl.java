...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromServerAddressByClientCIDRs(Predicate<io.kubernetes.client.openapi.models.V1ServerAddressByClientCIDRBuilder> predicate) {
  ...
  class PreferredVersionNestedImpl<N> extends V1GroupVersionForDiscoveryFluentImpl<V1APIGroupFluent.PreferredVersionNested<N>> implements io.kubernetes.client.openapi.models.V1APIGroupFluent.PreferredVersionNested<N>,Nested<N>{
  ...
  class ServerAddressByClientCIDRsNestedImpl<N> extends V1ServerAddressByClientCIDRFluentImpl<V1APIGroupFluent.ServerAddressByClientCIDRsNested<N>> implements io.kubernetes.client.openapi.models.V1APIGroupFluent.ServerAddressByClientCIDRsNested<N>,io.kubernetes.client.fluent.Nested<N>{
    ServerAddressByClientCIDRsNestedImpl(java.lang.Integer index,V1ServerAddressByClientCIDR item) {
      this.index = index;
  ...
  class VersionsNestedImpl<N> extends V1GroupVersionForDiscoveryFluentImpl<V1APIGroupFluent.VersionsNested<N>> implements io.kubernetes.client.openapi.models.V1APIGroupFluent.VersionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
