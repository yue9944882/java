...
import java.lang.Boolean;
  ...
  */
  ...
  public A removeMatchingFromNodeSelectorTerms(Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorTermBuilder> predicate) {
  ...
  public Boolean hasMatchingNodeSelectorTerm(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorTermBuilder> predicate) {
  ...
  class NodeSelectorTermsNestedImpl<N> extends V1NodeSelectorTermFluentImpl<V1NodeSelectorFluent.NodeSelectorTermsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSelectorFluent.NodeSelectorTermsNested<N>,Nested<N>{
