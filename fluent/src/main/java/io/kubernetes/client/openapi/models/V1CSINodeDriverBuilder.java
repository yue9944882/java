...
public class V1CSINodeDriverBuilder extends V1CSINodeDriverFluentImpl<V1CSINodeDriverBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1CSINodeDriver,V1CSINodeDriverBuilder>{
