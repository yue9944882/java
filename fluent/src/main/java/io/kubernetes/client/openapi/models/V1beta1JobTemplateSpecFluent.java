...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1beta1JobTemplateSpecFluent<A extends V1beta1JobTemplateSpecFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V1beta1JobTemplateSpecFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JobSpecFluent<V1beta1JobTemplateSpecFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
