...
import java.lang.Boolean;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CSINodeSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1CSINodeSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CSINodeFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CSINodeSpecFluentImpl<V1CSINodeFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CSINodeFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
