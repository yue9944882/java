...
public class V1ObjectFieldSelectorBuilder extends V1ObjectFieldSelectorFluentImpl<V1ObjectFieldSelectorBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1ObjectFieldSelector,V1ObjectFieldSelectorBuilder>{
