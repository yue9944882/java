...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToNamespaces(Integer index,java.lang.String item) {
    if (this.namespaces == null) {this.namespaces = new ArrayList<java.lang.String>();}
  ...
  class LabelSelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1PodAffinityTermFluent.LabelSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1PodAffinityTermFluent.LabelSelectorNested<N>,Nested<N>{
  ...
  class NamespaceSelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1PodAffinityTermFluent.NamespaceSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1PodAffinityTermFluent.NamespaceSelectorNested<N>,io.kubernetes.client.fluent.Nested<N>{
