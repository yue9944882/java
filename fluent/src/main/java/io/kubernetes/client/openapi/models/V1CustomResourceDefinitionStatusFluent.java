...
public interface V1CustomResourceDefinitionStatusFluent<A extends V1CustomResourceDefinitionStatusFluent<A>> extends Fluent<A>{
  ...
  public List<io.kubernetes.client.openapi.models.V1CustomResourceDefinitionCondition> getConditions();
  ...
  public interface ConditionsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CustomResourceDefinitionConditionFluent<V1CustomResourceDefinitionStatusFluent.ConditionsNested<N>>{
    public N and();
