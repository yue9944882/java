...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V2beta1ObjectMetricSourceFluent<A extends V2beta1ObjectMetricSourceFluent<A>> extends Fluent<A>{
  ...
  public interface SelectorNested<N> extends Nested<N>,V1LabelSelectorFluent<V2beta1ObjectMetricSourceFluent.SelectorNested<N>>{
    public N and();
    public N endSelector();
    
  }
  public interface TargetNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1CrossVersionObjectReferenceFluent<V2beta1ObjectMetricSourceFluent.TargetNested<N>>{
    public N and();
    public N endTarget();
