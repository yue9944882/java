...
import java.lang.Object;
  ...
  */
  ...
  public A addToRules(Integer index,io.kubernetes.client.openapi.models.V1PolicyRule item) {
    if (this.rules == null) {this.rules = new java.util.ArrayList<V1PolicyRuleBuilder>();}
  ...
  public A removeMatchingFromRules(Predicate<io.kubernetes.client.openapi.models.V1PolicyRuleBuilder> predicate) {
  ...
  class AggregationRuleNestedImpl<N> extends V1AggregationRuleFluentImpl<V1ClusterRoleFluent.AggregationRuleNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleFluent.AggregationRuleNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ClusterRoleFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class RulesNestedImpl<N> extends V1PolicyRuleFluentImpl<V1ClusterRoleFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
