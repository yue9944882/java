...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item : items) {io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder builder = new io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationBuilder> predicate) {
  ...
  public V1ValidatingWebhookConfigurationListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ValidatingWebhookConfiguration item) {
  ...
  class ItemsNestedImpl<N> extends V1ValidatingWebhookConfigurationFluentImpl<V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ValidatingWebhookConfigurationListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookConfigurationListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
