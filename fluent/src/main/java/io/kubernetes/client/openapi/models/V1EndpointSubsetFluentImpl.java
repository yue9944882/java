...
import java.lang.Object;
  ...
  */
  ...
  public A addAllToAddresses(Collection<io.kubernetes.client.openapi.models.V1EndpointAddress> items) {
    if (this.addresses == null) {this.addresses = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1EndpointAddressBuilder>();}
    for (io.kubernetes.client.openapi.models.V1EndpointAddress item : items) {io.kubernetes.client.openapi.models.V1EndpointAddressBuilder builder = new io.kubernetes.client.openapi.models.V1EndpointAddressBuilder(item);_visitables.get("addresses").add(builder);this.addresses.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromAddresses(Predicate<io.kubernetes.client.openapi.models.V1EndpointAddressBuilder> predicate) {
  ...
  public Boolean hasMatchingAddress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1EndpointAddressBuilder> predicate) {
  ...
  class AddressesNestedImpl<N> extends V1EndpointAddressFluentImpl<V1EndpointSubsetFluent.AddressesNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.AddressesNested<N>,Nested<N>{
  ...
  class NotReadyAddressesNestedImpl<N> extends V1EndpointAddressFluentImpl<V1EndpointSubsetFluent.NotReadyAddressesNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.NotReadyAddressesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PortsNestedImpl<N> extends CoreV1EndpointPortFluentImpl<V1EndpointSubsetFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSubsetFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
