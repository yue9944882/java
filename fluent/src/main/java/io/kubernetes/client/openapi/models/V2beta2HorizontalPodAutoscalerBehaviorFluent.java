...
public interface V2beta2HorizontalPodAutoscalerBehaviorFluent<A extends V2beta2HorizontalPodAutoscalerBehaviorFluent<A>> extends Fluent<A>{
  ...
  public interface ScaleUpNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2HPAScalingRulesFluent<V2beta2HorizontalPodAutoscalerBehaviorFluent.ScaleUpNested<N>>{
    public N and();
    public N endScaleUp();
