...
public interface V1PodAntiAffinityFluent<A extends V1PodAntiAffinityFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromRequiredDuringSchedulingIgnoredDuringExecution(java.util.function.Predicate<V1PodAffinityTermBuilder> predicate);
  ...
  public interface RequiredDuringSchedulingIgnoredDuringExecutionNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodAffinityTermFluent<V1PodAntiAffinityFluent.RequiredDuringSchedulingIgnoredDuringExecutionNested<N>>{
    public N and();
