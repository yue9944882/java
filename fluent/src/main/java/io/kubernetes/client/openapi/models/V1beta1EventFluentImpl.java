...
import java.lang.Object;
  ...
  */
  ...
  public A withSeries(io.kubernetes.client.openapi.models.V1beta1EventSeries series) {
    ...
    if (series!=null){ this.series= new V1beta1EventSeriesBuilder(series); _visitables.get("series").add(this.series);} return (A) this;
  }
  ...
  class DeprecatedSourceNestedImpl<N> extends V1EventSourceFluentImpl<V1beta1EventFluent.DeprecatedSourceNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventFluent.DeprecatedSourceNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1EventFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class RegardingNestedImpl<N> extends V1ObjectReferenceFluentImpl<V1beta1EventFluent.RegardingNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventFluent.RegardingNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class RelatedNestedImpl<N> extends V1ObjectReferenceFluentImpl<V1beta1EventFluent.RelatedNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventFluent.RelatedNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SeriesNestedImpl<N> extends V1beta1EventSeriesFluentImpl<V1beta1EventFluent.SeriesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventFluent.SeriesNested<N>,io.kubernetes.client.fluent.Nested<N>{
