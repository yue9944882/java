...
public interface V1beta1PodSecurityPolicySpecFluent<A extends V1beta1PodSecurityPolicySpecFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromAllowedFlexVolumes(java.util.function.Predicate<V1beta1AllowedFlexVolumeBuilder> predicate);
  ...
  public A removeMatchingFromAllowedHostPaths(java.util.function.Predicate<V1beta1AllowedHostPathBuilder> predicate);
  ...
  public A removeMatchingFromHostPorts(java.util.function.Predicate<V1beta1HostPortRangeBuilder> predicate);
  ...
  public interface AllowedCSIDriversNested<N> extends Nested<N>,V1beta1AllowedCSIDriverFluent<V1beta1PodSecurityPolicySpecFluent.AllowedCSIDriversNested<N>>{
    public N and();
    public N endAllowedCSIDriver();
    
  }
  public interface AllowedFlexVolumesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1AllowedFlexVolumeFluent<V1beta1PodSecurityPolicySpecFluent.AllowedFlexVolumesNested<N>>{
    public N and();
    public N endAllowedFlexVolume();
    
  }
  public interface AllowedHostPathsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1AllowedHostPathFluent<V1beta1PodSecurityPolicySpecFluent.AllowedHostPathsNested<N>>{
    public N and();
    public N endAllowedHostPath();
    
  }
  public interface FsGroupNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1FSGroupStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.FsGroupNested<N>>{
    public N and();
    public N endFsGroup();
    
  }
  public interface HostPortsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1HostPortRangeFluent<V1beta1PodSecurityPolicySpecFluent.HostPortsNested<N>>{
    public N and();
    public N endHostPort();
    
  }
  public interface RunAsGroupNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1RunAsGroupStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.RunAsGroupNested<N>>{
    public N and();
    public N endRunAsGroup();
    
  }
  public interface RunAsUserNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1RunAsUserStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.RunAsUserNested<N>>{
    public N and();
    public N endRunAsUser();
    
  }
  public interface RuntimeClassNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1RuntimeClassStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.RuntimeClassNested<N>>{
    public N and();
    public N endRuntimeClass();
    
  }
  public interface SeLinuxNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1SELinuxStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.SeLinuxNested<N>>{
    public N and();
    public N endSeLinux();
    
  }
  public interface SupplementalGroupsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1beta1SupplementalGroupsStrategyOptionsFluent<V1beta1PodSecurityPolicySpecFluent.SupplementalGroupsNested<N>>{
    public N and();
