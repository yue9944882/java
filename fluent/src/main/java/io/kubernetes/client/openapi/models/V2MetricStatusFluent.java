...
public interface V2MetricStatusFluent<A extends V2MetricStatusFluent<A>> extends Fluent<A>{
  ...
  public interface ExternalNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2ExternalMetricStatusFluent<V2MetricStatusFluent.ExternalNested<N>>{
    public N and();
    public N endExternal();
    
  }
  public interface ObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2ObjectMetricStatusFluent<V2MetricStatusFluent.ObjectNested<N>>{
    public N and();
    public N endObject();
    
  }
  public interface PodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2PodsMetricStatusFluent<V2MetricStatusFluent.PodsNested<N>>{
    public N and();
    public N endPods();
    
  }
  public interface ResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2ResourceMetricStatusFluent<V2MetricStatusFluent.ResourceNested<N>>{
    public N and();
