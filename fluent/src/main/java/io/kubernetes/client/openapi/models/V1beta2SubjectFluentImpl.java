...
import java.lang.Object;
  ...
  */
  ...
  public A withServiceAccount(io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubject serviceAccount) {
    ...
    if (serviceAccount!=null){ this.serviceAccount= new V1beta2ServiceAccountSubjectBuilder(serviceAccount); _visitables.get("serviceAccount").add(this.serviceAccount);} return (A) this;
  }
  ...
  public A withUser(io.kubernetes.client.openapi.models.V1beta2UserSubject user) {
    ...
    if (user!=null){ this.user= new V1beta2UserSubjectBuilder(user); _visitables.get("user").add(this.user);} return (A) this;
  }
  ...
  class GroupNestedImpl<N> extends V1beta2GroupSubjectFluentImpl<V1beta2SubjectFluent.GroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.GroupNested<N>,Nested<N>{
  ...
  class ServiceAccountNestedImpl<N> extends V1beta2ServiceAccountSubjectFluentImpl<V1beta2SubjectFluent.ServiceAccountNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.ServiceAccountNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class UserNestedImpl<N> extends V1beta2UserSubjectFluentImpl<V1beta2SubjectFluent.UserNested<N>> implements io.kubernetes.client.openapi.models.V1beta2SubjectFluent.UserNested<N>,io.kubernetes.client.fluent.Nested<N>{
