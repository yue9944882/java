...
public interface V1MutatingWebhookFluent<A extends V1MutatingWebhookFluent<A>> extends Fluent<A>{
  ...
  public interface NamespaceSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1MutatingWebhookFluent.NamespaceSelectorNested<N>>{
    public N and();
    public N endNamespaceSelector();
    
  }
  public interface ObjectSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1MutatingWebhookFluent.ObjectSelectorNested<N>>{
    public N and();
    public N endObjectSelector();
    
  }
  public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1RuleWithOperationsFluent<V1MutatingWebhookFluent.RulesNested<N>>{
    public N and();
    public N endRule();
