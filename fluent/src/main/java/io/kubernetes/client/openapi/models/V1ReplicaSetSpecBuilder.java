...
public class V1ReplicaSetSpecBuilder extends V1ReplicaSetSpecFluentImpl<V1ReplicaSetSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1ReplicaSetSpec,io.kubernetes.client.openapi.models.V1ReplicaSetSpecBuilder>{
