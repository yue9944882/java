...
import java.lang.Object;
  ...
  */
  ...
  class NodeAffinityNestedImpl<N> extends V1NodeAffinityFluentImpl<V1AffinityFluent.NodeAffinityNested<N>> implements io.kubernetes.client.openapi.models.V1AffinityFluent.NodeAffinityNested<N>,Nested<N>{
  ...
  class PodAffinityNestedImpl<N> extends V1PodAffinityFluentImpl<V1AffinityFluent.PodAffinityNested<N>> implements io.kubernetes.client.openapi.models.V1AffinityFluent.PodAffinityNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodAntiAffinityNestedImpl<N> extends V1PodAntiAffinityFluentImpl<V1AffinityFluent.PodAntiAffinityNested<N>> implements io.kubernetes.client.openapi.models.V1AffinityFluent.PodAntiAffinityNested<N>,io.kubernetes.client.fluent.Nested<N>{
