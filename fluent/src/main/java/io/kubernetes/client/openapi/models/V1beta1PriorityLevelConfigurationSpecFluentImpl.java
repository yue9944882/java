...
import java.lang.Boolean;
  ...
  */
  ...
  public A withLimited(io.kubernetes.client.openapi.models.V1beta1LimitedPriorityLevelConfiguration limited) {
    ...
    if (limited!=null){ this.limited= new V1beta1LimitedPriorityLevelConfigurationBuilder(limited); _visitables.get("limited").add(this.limited);} return (A) this;
  }
  ...
  class LimitedNestedImpl<N> extends V1beta1LimitedPriorityLevelConfigurationFluentImpl<V1beta1PriorityLevelConfigurationSpecFluent.LimitedNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationSpecFluent.LimitedNested<N>,Nested<N>{
