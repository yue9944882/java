...
public class V1VolumeDeviceBuilder extends V1VolumeDeviceFluentImpl<V1VolumeDeviceBuilder> implements VisitableBuilder<V1VolumeDevice,io.kubernetes.client.openapi.models.V1VolumeDeviceBuilder>{
