...
public class V1VolumeErrorBuilder extends V1VolumeErrorFluentImpl<V1VolumeErrorBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1VolumeError,V1VolumeErrorBuilder>{
