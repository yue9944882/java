...
public class V1JobStatusBuilder extends V1JobStatusFluentImpl<V1JobStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1JobStatus,io.kubernetes.client.openapi.models.V1JobStatusBuilder>{
