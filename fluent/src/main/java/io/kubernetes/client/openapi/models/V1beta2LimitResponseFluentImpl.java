...
import java.lang.Boolean;
  ...
  */
  ...
  public A withQueuing(io.kubernetes.client.openapi.models.V1beta2QueuingConfiguration queuing) {
    ...
    if (queuing!=null){ this.queuing= new V1beta2QueuingConfigurationBuilder(queuing); _visitables.get("queuing").add(this.queuing);} return (A) this;
  }
  ...
  class QueuingNestedImpl<N> extends V1beta2QueuingConfigurationFluentImpl<V1beta2LimitResponseFluent.QueuingNested<N>> implements io.kubernetes.client.openapi.models.V1beta2LimitResponseFluent.QueuingNested<N>,Nested<N>{
