...
public class V1ProbeBuilder extends V1ProbeFluentImpl<V1ProbeBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1Probe,V1ProbeBuilder>{
