...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromImagePullSecrets(Predicate<io.kubernetes.client.openapi.models.V1LocalObjectReferenceBuilder> predicate) {
  ...
  public A addToSecrets(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ObjectReference item) {
    if (this.secrets == null) {this.secrets = new java.util.ArrayList<V1ObjectReferenceBuilder>();}
  ...
  class ImagePullSecretsNestedImpl<N> extends V1LocalObjectReferenceFluentImpl<V1ServiceAccountFluent.ImagePullSecretsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceAccountFluent.ImagePullSecretsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ServiceAccountFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceAccountFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SecretsNestedImpl<N> extends V1ObjectReferenceFluentImpl<V1ServiceAccountFluent.SecretsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceAccountFluent.SecretsNested<N>,io.kubernetes.client.fluent.Nested<N>{
