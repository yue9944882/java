...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1beta1EndpointHintsFluentImpl<A extends V1beta1EndpointHintsFluent<A>> extends BaseFluent<A> implements V1beta1EndpointHintsFluent<A>{
  ...
  public A addToForZones(Integer index,io.kubernetes.client.openapi.models.V1beta1ForZone item) {
    if (this.forZones == null) {this.forZones = new java.util.ArrayList<V1beta1ForZoneBuilder>();}
  ...
  public A removeMatchingFromForZones(Predicate<io.kubernetes.client.openapi.models.V1beta1ForZoneBuilder> predicate) {
  ...
  class ForZonesNestedImpl<N> extends V1beta1ForZoneFluentImpl<V1beta1EndpointHintsFluent.ForZonesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointHintsFluent.ForZonesNested<N>,Nested<N>{
