...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToConditions(Integer index,io.kubernetes.client.openapi.models.V1beta1FlowSchemaCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<V1beta1FlowSchemaConditionBuilder>();}
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1beta1FlowSchemaConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1beta1FlowSchemaConditionFluentImpl<V1beta1FlowSchemaStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1FlowSchemaStatusFluent.ConditionsNested<N>,Nested<N>{
