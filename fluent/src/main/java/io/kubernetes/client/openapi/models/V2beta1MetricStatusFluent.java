...
public interface V2beta1MetricStatusFluent<A extends V2beta1MetricStatusFluent<A>> extends Fluent<A>{
  ...
  public interface ContainerResourceNested<N> extends Nested<N>,V2beta1ContainerResourceMetricStatusFluent<V2beta1MetricStatusFluent.ContainerResourceNested<N>>{
    public N and();
    public N endContainerResource();
    
  }
  public interface ExternalNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ExternalMetricStatusFluent<V2beta1MetricStatusFluent.ExternalNested<N>>{
    public N and();
    public N endExternal();
    
  }
  public interface ObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ObjectMetricStatusFluent<V2beta1MetricStatusFluent.ObjectNested<N>>{
    public N and();
    public N endObject();
    
  }
  public interface PodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1PodsMetricStatusFluent<V2beta1MetricStatusFluent.PodsNested<N>>{
    public N and();
    public N endPods();
    
  }
  public interface ResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ResourceMetricStatusFluent<V2beta1MetricStatusFluent.ResourceNested<N>>{
    public N and();
