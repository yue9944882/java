...
import java.lang.Object;
  ...
  */
  ...
  public A addToNonResourceRules(Integer index,io.kubernetes.client.openapi.models.V1NonResourceRule item) {
    if (this.nonResourceRules == null) {this.nonResourceRules = new java.util.ArrayList<V1NonResourceRuleBuilder>();}
  ...
  public A addAllToNonResourceRules(Collection<io.kubernetes.client.openapi.models.V1NonResourceRule> items) {
    if (this.nonResourceRules == null) {this.nonResourceRules = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder>();}
    for (io.kubernetes.client.openapi.models.V1NonResourceRule item : items) {io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder builder = new io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder(item);_visitables.get("nonResourceRules").add(builder);this.nonResourceRules.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromNonResourceRules(Predicate<io.kubernetes.client.openapi.models.V1NonResourceRuleBuilder> predicate) {
  ...
  public A addToResourceRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ResourceRule item) {
    if (this.resourceRules == null) {this.resourceRules = new java.util.ArrayList<V1ResourceRuleBuilder>();}
  ...
  class NonResourceRulesNestedImpl<N> extends V1NonResourceRuleFluentImpl<V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<N>> implements io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.NonResourceRulesNested<N>,Nested<N>{
  ...
  class ResourceRulesNestedImpl<N> extends V1ResourceRuleFluentImpl<V1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>> implements io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
