...
public interface V2beta2HorizontalPodAutoscalerStatusFluent<A extends V2beta2HorizontalPodAutoscalerStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromCurrentMetrics(java.util.function.Predicate<V2beta2MetricStatusBuilder> predicate);
  ...
  public interface CurrentMetricsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricStatusFluent<V2beta2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>>{
    public N and();
