...
import java.util.Map;
  ...
  * Generated
  */
public interface V1beta1SchedulingFluent<A extends V1beta1SchedulingFluent<A>> extends Fluent<A>{
  ...
  public interface TolerationsNested<N> extends Nested<N>,V1TolerationFluent<V1beta1SchedulingFluent.TolerationsNested<N>>{
    public N and();
