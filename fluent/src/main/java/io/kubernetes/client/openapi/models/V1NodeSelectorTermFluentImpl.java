...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToMatchExpressions(Integer index,io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item) {
  ...
  public A addAllToMatchExpressions(Collection<io.kubernetes.client.openapi.models.V1NodeSelectorRequirement> items) {
    if (this.matchExpressions == null) {this.matchExpressions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder>();}
    for (io.kubernetes.client.openapi.models.V1NodeSelectorRequirement item : items) {io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder builder = new io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder(item);_visitables.get("matchExpressions").add(builder);this.matchExpressions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromMatchExpressions(Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
  ...
  public Boolean hasMatchingMatchExpression(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeSelectorRequirementBuilder> predicate) {
  ...
  class MatchExpressionsNestedImpl<N> extends V1NodeSelectorRequirementFluentImpl<V1NodeSelectorTermFluent.MatchExpressionsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchExpressionsNested<N>,Nested<N>{
  ...
  class MatchFieldsNestedImpl<N> extends V1NodeSelectorRequirementFluentImpl<V1NodeSelectorTermFluent.MatchFieldsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSelectorTermFluent.MatchFieldsNested<N>,io.kubernetes.client.fluent.Nested<N>{
