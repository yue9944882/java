...
public class V1MutatingWebhookConfigurationBuilder extends V1MutatingWebhookConfigurationFluentImpl<V1MutatingWebhookConfigurationBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1MutatingWebhookConfiguration,io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationBuilder>{
