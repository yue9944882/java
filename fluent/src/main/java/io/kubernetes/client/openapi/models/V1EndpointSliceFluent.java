...
public interface V1EndpointSliceFluent<A extends V1EndpointSliceFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromPorts(java.util.function.Predicate<DiscoveryV1EndpointPortBuilder> predicate);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ObjectMetaFluent<V1EndpointSliceFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface PortsNested<N> extends io.kubernetes.client.fluent.Nested<N>,DiscoveryV1EndpointPortFluent<V1EndpointSliceFluent.PortsNested<N>>{
    public N and();
    public N endPort();
