...
public interface V1CSINodeListFluent<A extends V1CSINodeListFluent<A>> extends Fluent<A>{
  ...
  public V1CSINodeListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1CSINode item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1CSINodeListFluent.MetadataNested<N>>{
    public N and();
