...
import java.lang.Boolean;
  ...
  */
  ...
  public A addAllToConditions(Collection<io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition> items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition item : items) {io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder builder = new io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> predicate) {
  ...
  public Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1beta2FlowSchemaConditionFluentImpl<V1beta2FlowSchemaStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatusFluent.ConditionsNested<N>,Nested<N>{
