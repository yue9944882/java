...
import java.util.Map;
  ...
  */
  ...
  public A addToAddresses(Integer index,java.lang.String item) {
    if (this.addresses == null) {this.addresses = new ArrayList<java.lang.String>();}
  ...
  public A withConditions(io.kubernetes.client.openapi.models.V1EndpointConditions conditions) {
    ...
    if (conditions!=null){ this.conditions= new V1EndpointConditionsBuilder(conditions); _visitables.get("conditions").add(this.conditions);} return (A) this;
  }
  ...
  public A withHints(io.kubernetes.client.openapi.models.V1EndpointHints hints) {
    ...
    if (hints!=null){ this.hints= new V1EndpointHintsBuilder(hints); _visitables.get("hints").add(this.hints);} return (A) this;
  }
  ...
  class ConditionsNestedImpl<N> extends V1EndpointConditionsFluentImpl<V1EndpointFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.ConditionsNested<N>,Nested<N>{
  ...
  class HintsNestedImpl<N> extends V1EndpointHintsFluentImpl<V1EndpointFluent.HintsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.HintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TargetRefNestedImpl<N> extends V1ObjectReferenceFluentImpl<V1EndpointFluent.TargetRefNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointFluent.TargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
