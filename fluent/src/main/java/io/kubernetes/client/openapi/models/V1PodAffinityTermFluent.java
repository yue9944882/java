...
public interface V1PodAffinityTermFluent<A extends V1PodAffinityTermFluent<A>> extends Fluent<A>{
  ...
  public interface NamespaceSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1PodAffinityTermFluent.NamespaceSelectorNested<N>>{
    public N and();
