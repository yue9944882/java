...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToClusterRoleSelectors(Integer index,io.kubernetes.client.openapi.models.V1LabelSelector item) {
    if (this.clusterRoleSelectors == null) {this.clusterRoleSelectors = new java.util.ArrayList<V1LabelSelectorBuilder>();}
  ...
  public A addAllToClusterRoleSelectors(Collection<io.kubernetes.client.openapi.models.V1LabelSelector> items) {
    if (this.clusterRoleSelectors == null) {this.clusterRoleSelectors = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder>();}
    for (io.kubernetes.client.openapi.models.V1LabelSelector item : items) {io.kubernetes.client.openapi.models.V1LabelSelectorBuilder builder = new io.kubernetes.client.openapi.models.V1LabelSelectorBuilder(item);_visitables.get("clusterRoleSelectors").add(builder);this.clusterRoleSelectors.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromClusterRoleSelectors(Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
  ...
  public Boolean hasMatchingClusterRoleSelector(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1LabelSelectorBuilder> predicate) {
  ...
  class ClusterRoleSelectorsNestedImpl<N> extends V1LabelSelectorFluentImpl<V1AggregationRuleFluent.ClusterRoleSelectorsNested<N>> implements io.kubernetes.client.openapi.models.V1AggregationRuleFluent.ClusterRoleSelectorsNested<N>,Nested<N>{
