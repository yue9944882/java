...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1ReplicaSetSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1ReplicaSetSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1ReplicaSetStatus status) {
    ...
    if (status!=null){ this.status= new V1ReplicaSetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ReplicaSetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicaSetFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ReplicaSetSpecFluentImpl<V1ReplicaSetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicaSetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ReplicaSetStatusFluentImpl<V1ReplicaSetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicaSetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
