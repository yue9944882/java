...
return result;
  ...
  public A addToCaBundle(Integer index,java.lang.Byte item) {
    if (this.caBundle == null) {this.caBundle =  new ArrayList<java.lang.Byte>();}
  ...
  public A withService(io.kubernetes.client.openapi.models.AdmissionregistrationV1ServiceReference service) {
    ...
    if (service!=null){ this.service= new AdmissionregistrationV1ServiceReferenceBuilder(service); _visitables.get("service").add(this.service);} return (A) this;
  }
  ...
  class ServiceNestedImpl<N> extends AdmissionregistrationV1ServiceReferenceFluentImpl<AdmissionregistrationV1WebhookClientConfigFluent.ServiceNested<N>> implements io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfigFluent.ServiceNested<N>,Nested<N>{
