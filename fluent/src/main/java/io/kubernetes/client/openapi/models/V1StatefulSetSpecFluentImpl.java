...
import java.lang.Object;
  ...
  */
  ...
  private V1StatefulSetSpec.PodManagementPolicyEnum podManagementPolicy;
  ...
  public A withUpdateStrategy(io.kubernetes.client.openapi.models.V1StatefulSetUpdateStrategy updateStrategy) {
    ...
    if (updateStrategy!=null){ this.updateStrategy= new V1StatefulSetUpdateStrategyBuilder(updateStrategy); _visitables.get("updateStrategy").add(this.updateStrategy);} return (A) this;
  }
  ...
  public A addToVolumeClaimTemplates(java.lang.Integer index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
    if (this.volumeClaimTemplates == null) {this.volumeClaimTemplates = new java.util.ArrayList<V1PersistentVolumeClaimBuilder>();}
  ...
  public A addAllToVolumeClaimTemplates(Collection<io.kubernetes.client.openapi.models.V1PersistentVolumeClaim> items) {
    if (this.volumeClaimTemplates == null) {this.volumeClaimTemplates = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>();}
    for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item : items) {io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder(item);_visitables.get("volumeClaimTemplates").add(builder);this.volumeClaimTemplates.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromVolumeClaimTemplates(Predicate<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> predicate) {
  ...
  class PersistentVolumeClaimRetentionPolicyNestedImpl<N> extends V1StatefulSetPersistentVolumeClaimRetentionPolicyFluentImpl<V1StatefulSetSpecFluent.PersistentVolumeClaimRetentionPolicyNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetSpecFluent.PersistentVolumeClaimRetentionPolicyNested<N>,Nested<N>{
  ...
  class SelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1StatefulSetSpecFluent.SelectorNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetSpecFluent.SelectorNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TemplateNestedImpl<N> extends V1PodTemplateSpecFluentImpl<V1StatefulSetSpecFluent.TemplateNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetSpecFluent.TemplateNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class UpdateStrategyNestedImpl<N> extends V1StatefulSetUpdateStrategyFluentImpl<V1StatefulSetSpecFluent.UpdateStrategyNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetSpecFluent.UpdateStrategyNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class VolumeClaimTemplatesNestedImpl<N> extends V1PersistentVolumeClaimFluentImpl<V1StatefulSetSpecFluent.VolumeClaimTemplatesNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetSpecFluent.VolumeClaimTemplatesNested<N>,io.kubernetes.client.fluent.Nested<N>{
