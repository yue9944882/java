...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1beta1PodSecurityPolicyFluentImpl<A extends V1beta1PodSecurityPolicyFluent<A>> extends BaseFluent<A> implements V1beta1PodSecurityPolicyFluent<A>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1PodSecurityPolicyFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicyFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1beta1PodSecurityPolicySpecFluentImpl<V1beta1PodSecurityPolicyFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicyFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
