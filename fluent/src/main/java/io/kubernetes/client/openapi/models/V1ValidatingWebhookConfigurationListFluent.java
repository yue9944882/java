...
public interface V1ValidatingWebhookConfigurationListFluent<A extends V1ValidatingWebhookConfigurationListFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1ValidatingWebhookConfigurationListFluent.MetadataNested<N>>{
    public N and();
