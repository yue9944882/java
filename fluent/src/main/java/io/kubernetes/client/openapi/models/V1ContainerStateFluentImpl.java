...
import java.lang.Object;
  ...
  */
  ...
  public A withRunning(io.kubernetes.client.openapi.models.V1ContainerStateRunning running) {
    ...
    if (running!=null){ this.running= new V1ContainerStateRunningBuilder(running); _visitables.get("running").add(this.running);} return (A) this;
  }
  ...
  public A withTerminated(io.kubernetes.client.openapi.models.V1ContainerStateTerminated terminated) {
    ...
    if (terminated!=null){ this.terminated= new V1ContainerStateTerminatedBuilder(terminated); _visitables.get("terminated").add(this.terminated);} return (A) this;
  }
  ...
  class RunningNestedImpl<N> extends V1ContainerStateRunningFluentImpl<V1ContainerStateFluent.RunningNested<N>> implements io.kubernetes.client.openapi.models.V1ContainerStateFluent.RunningNested<N>,Nested<N>{
  ...
  class TerminatedNestedImpl<N> extends V1ContainerStateTerminatedFluentImpl<V1ContainerStateFluent.TerminatedNested<N>> implements io.kubernetes.client.openapi.models.V1ContainerStateFluent.TerminatedNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class WaitingNestedImpl<N> extends V1ContainerStateWaitingFluentImpl<V1ContainerStateFluent.WaitingNested<N>> implements io.kubernetes.client.openapi.models.V1ContainerStateFluent.WaitingNested<N>,io.kubernetes.client.fluent.Nested<N>{
