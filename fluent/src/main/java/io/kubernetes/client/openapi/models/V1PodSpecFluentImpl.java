...
import java.lang.Integer;
  ...
  */
  ...
  private V1PodSpec.DnsPolicyEnum dnsPolicy;
  ...
  private V1PodSpec.RestartPolicyEnum restartPolicy;
  ...
  public A removeMatchingFromContainers(Predicate<io.kubernetes.client.openapi.models.V1ContainerBuilder> predicate) {
  ...
  public A addToHostAliases(java.lang.Integer index,io.kubernetes.client.openapi.models.V1HostAlias item) {
    if (this.hostAliases == null) {this.hostAliases = new java.util.ArrayList<V1HostAliasBuilder>();}
  ...
  public A withOs(io.kubernetes.client.openapi.models.V1PodOS os) {
    ...
    if (os!=null){ this.os= new V1PodOSBuilder(os); _visitables.get("os").add(this.os);} return (A) this;
  }
  ...
  public A withSecurityContext(io.kubernetes.client.openapi.models.V1PodSecurityContext securityContext) {
    ...
    if (securityContext!=null){ this.securityContext= new V1PodSecurityContextBuilder(securityContext); _visitables.get("securityContext").add(this.securityContext);} return (A) this;
  }
  ...
  public A addToVolumes(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Volume item) {
    if (this.volumes == null) {this.volumes = new java.util.ArrayList<V1VolumeBuilder>();}
  ...
  class AffinityNestedImpl<N> extends V1AffinityFluentImpl<V1PodSpecFluent.AffinityNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.AffinityNested<N>,Nested<N>{
  ...
  class ContainersNestedImpl<N> extends V1ContainerFluentImpl<V1PodSpecFluent.ContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class DnsConfigNestedImpl<N> extends V1PodDNSConfigFluentImpl<V1PodSpecFluent.DnsConfigNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.DnsConfigNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class EphemeralContainersNestedImpl<N> extends V1EphemeralContainerFluentImpl<V1PodSpecFluent.EphemeralContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.EphemeralContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class HostAliasesNestedImpl<N> extends V1HostAliasFluentImpl<V1PodSpecFluent.HostAliasesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.HostAliasesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ImagePullSecretsNestedImpl<N> extends V1LocalObjectReferenceFluentImpl<V1PodSpecFluent.ImagePullSecretsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ImagePullSecretsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class InitContainersNestedImpl<N> extends V1ContainerFluentImpl<V1PodSpecFluent.InitContainersNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.InitContainersNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class OsNestedImpl<N> extends V1PodOSFluentImpl<V1PodSpecFluent.OsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.OsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ReadinessGatesNestedImpl<N> extends V1PodReadinessGateFluentImpl<V1PodSpecFluent.ReadinessGatesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.ReadinessGatesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SecurityContextNestedImpl<N> extends V1PodSecurityContextFluentImpl<V1PodSpecFluent.SecurityContextNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.SecurityContextNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TolerationsNestedImpl<N> extends V1TolerationFluentImpl<V1PodSpecFluent.TolerationsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.TolerationsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TopologySpreadConstraintsNestedImpl<N> extends V1TopologySpreadConstraintFluentImpl<V1PodSpecFluent.TopologySpreadConstraintsNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.TopologySpreadConstraintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class VolumesNestedImpl<N> extends V1VolumeFluentImpl<V1PodSpecFluent.VolumesNested<N>> implements io.kubernetes.client.openapi.models.V1PodSpecFluent.VolumesNested<N>,io.kubernetes.client.fluent.Nested<N>{
