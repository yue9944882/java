...
public interface V1ResourceQuotaFluent<A extends V1ResourceQuotaFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ResourceQuotaSpecFluent<V1ResourceQuotaFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ResourceQuotaStatusFluent<V1ResourceQuotaFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
