...
public interface V1ReplicaSetFluent<A extends V1ReplicaSetFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ReplicaSetSpecFluent<V1ReplicaSetFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ReplicaSetStatusFluent<V1ReplicaSetFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
