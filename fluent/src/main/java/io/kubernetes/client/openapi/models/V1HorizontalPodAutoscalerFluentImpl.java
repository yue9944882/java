...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1HorizontalPodAutoscalerSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1HorizontalPodAutoscalerFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1HorizontalPodAutoscalerSpecFluentImpl<V1HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1HorizontalPodAutoscalerStatusFluentImpl<V1HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
