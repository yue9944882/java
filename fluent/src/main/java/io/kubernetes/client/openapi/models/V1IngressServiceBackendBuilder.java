...
public class V1IngressServiceBackendBuilder extends V1IngressServiceBackendFluentImpl<V1IngressServiceBackendBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1IngressServiceBackend,io.kubernetes.client.openapi.models.V1IngressServiceBackendBuilder>{
