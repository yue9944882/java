...
public interface V1SelfSubjectRulesReviewFluent<A extends V1SelfSubjectRulesReviewFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SelfSubjectRulesReviewSpecFluent<V1SelfSubjectRulesReviewFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SubjectRulesReviewStatusFluent<V1SelfSubjectRulesReviewFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
