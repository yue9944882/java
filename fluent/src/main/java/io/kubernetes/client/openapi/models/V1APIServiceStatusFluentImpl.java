...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToConditions(Integer index,io.kubernetes.client.openapi.models.V1APIServiceCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<V1APIServiceConditionBuilder>();}
  ...
  public A addAllToConditions(Collection<io.kubernetes.client.openapi.models.V1APIServiceCondition> items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1APIServiceCondition item : items) {io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder builder = new io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder> predicate) {
  ...
  public Boolean hasMatchingCondition(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1APIServiceConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1APIServiceConditionFluentImpl<V1APIServiceStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceStatusFluent.ConditionsNested<N>,Nested<N>{
