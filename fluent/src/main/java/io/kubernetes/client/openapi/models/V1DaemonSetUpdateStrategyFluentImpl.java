...
import java.lang.Boolean;
  ...
  */
  ...
  private V1DaemonSetUpdateStrategy.TypeEnum type;
  ...
  public A withRollingUpdate(io.kubernetes.client.openapi.models.V1RollingUpdateDaemonSet rollingUpdate) {
    ...
    if (rollingUpdate!=null){ this.rollingUpdate= new V1RollingUpdateDaemonSetBuilder(rollingUpdate); _visitables.get("rollingUpdate").add(this.rollingUpdate);} return (A) this;
  }
  ...
  class RollingUpdateNestedImpl<N> extends V1RollingUpdateDaemonSetFluentImpl<V1DaemonSetUpdateStrategyFluent.RollingUpdateNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetUpdateStrategyFluent.RollingUpdateNested<N>,Nested<N>{
