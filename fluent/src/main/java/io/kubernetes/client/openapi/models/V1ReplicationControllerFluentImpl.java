...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1ReplicationControllerSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1ReplicationControllerSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1ReplicationControllerStatus status) {
    ...
    if (status!=null){ this.status= new V1ReplicationControllerStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ReplicationControllerFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicationControllerFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ReplicationControllerSpecFluentImpl<V1ReplicationControllerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicationControllerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ReplicationControllerStatusFluentImpl<V1ReplicationControllerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicationControllerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
