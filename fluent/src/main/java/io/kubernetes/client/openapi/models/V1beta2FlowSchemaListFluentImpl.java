...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1beta2FlowSchemaBuilder> predicate) {
  ...
  public V1beta2FlowSchemaListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1beta2FlowSchema item) {
  ...
  class ItemsNestedImpl<N> extends V1beta2FlowSchemaFluentImpl<V1beta2FlowSchemaListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta2FlowSchemaListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta2FlowSchemaListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
