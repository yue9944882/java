...
import java.lang.Object;
  ...
  */
  ...
  public A withStrategy(io.kubernetes.client.openapi.models.V1DeploymentStrategy strategy) {
    ...
    if (strategy!=null){ this.strategy= new V1DeploymentStrategyBuilder(strategy); _visitables.get("strategy").add(this.strategy);} return (A) this;
  }
  ...
  class SelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1DeploymentSpecFluent.SelectorNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentSpecFluent.SelectorNested<N>,Nested<N>{
  ...
  class StrategyNestedImpl<N> extends V1DeploymentStrategyFluentImpl<V1DeploymentSpecFluent.StrategyNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentSpecFluent.StrategyNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TemplateNestedImpl<N> extends V1PodTemplateSpecFluentImpl<V1DeploymentSpecFluent.TemplateNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentSpecFluent.TemplateNested<N>,io.kubernetes.client.fluent.Nested<N>{
