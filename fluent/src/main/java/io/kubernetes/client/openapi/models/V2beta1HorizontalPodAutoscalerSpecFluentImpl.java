...
import java.lang.Object;
  ...
  */
  ...
  public A addAllToMetrics(Collection<io.kubernetes.client.openapi.models.V2beta1MetricSpec> items) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder>();}
    for (io.kubernetes.client.openapi.models.V2beta1MetricSpec item : items) {io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder builder = new io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder(item);_visitables.get("metrics").add(builder);this.metrics.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromMetrics(Predicate<io.kubernetes.client.openapi.models.V2beta1MetricSpecBuilder> predicate) {
  ...
  class MetricsNestedImpl<N> extends V2beta1MetricSpecFluentImpl<V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<N>,Nested<N>{
  ...
  class ScaleTargetRefNestedImpl<N> extends V2beta1CrossVersionObjectReferenceFluentImpl<V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
