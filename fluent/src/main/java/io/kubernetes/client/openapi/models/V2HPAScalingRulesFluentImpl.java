...
import java.lang.Boolean;
  ...
  */
  ...
  public A addAllToPolicies(Collection<io.kubernetes.client.openapi.models.V2HPAScalingPolicy> items) {
    if (this.policies == null) {this.policies = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder>();}
    for (io.kubernetes.client.openapi.models.V2HPAScalingPolicy item : items) {io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder builder = new io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder(item);_visitables.get("policies").add(builder);this.policies.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromPolicies(Predicate<io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder> predicate) {
  ...
  public Boolean hasMatchingPolicy(java.util.function.Predicate<io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder> predicate) {
  ...
  class PoliciesNestedImpl<N> extends V2HPAScalingPolicyFluentImpl<V2HPAScalingRulesFluent.PoliciesNested<N>> implements io.kubernetes.client.openapi.models.V2HPAScalingRulesFluent.PoliciesNested<N>,Nested<N>{
