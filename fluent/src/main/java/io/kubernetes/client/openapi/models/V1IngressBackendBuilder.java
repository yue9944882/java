...
public class V1IngressBackendBuilder extends V1IngressBackendFluentImpl<V1IngressBackendBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1IngressBackend,V1IngressBackendBuilder>{
