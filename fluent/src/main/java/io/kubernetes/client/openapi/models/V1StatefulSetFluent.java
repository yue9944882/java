...
public interface V1StatefulSetFluent<A extends V1StatefulSetFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1StatefulSetSpecFluent<V1StatefulSetFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1StatefulSetStatusFluent<V1StatefulSetFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
