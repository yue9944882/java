...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1ConditionBuilder> predicate) {
  ...
  public A withLoadBalancer(io.kubernetes.client.openapi.models.V1LoadBalancerStatus loadBalancer) {
    ...
    if (loadBalancer!=null){ this.loadBalancer= new V1LoadBalancerStatusBuilder(loadBalancer); _visitables.get("loadBalancer").add(this.loadBalancer);} return (A) this;
  }
  ...
  class ConditionsNestedImpl<N> extends V1ConditionFluentImpl<V1ServiceStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceStatusFluent.ConditionsNested<N>,Nested<N>{
  ...
  class LoadBalancerNestedImpl<N> extends V1LoadBalancerStatusFluentImpl<V1ServiceStatusFluent.LoadBalancerNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceStatusFluent.LoadBalancerNested<N>,io.kubernetes.client.fluent.Nested<N>{
