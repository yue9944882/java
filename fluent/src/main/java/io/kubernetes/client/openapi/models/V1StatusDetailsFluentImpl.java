...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToCauses(java.lang.Integer index,io.kubernetes.client.openapi.models.V1StatusCause item) {
    if (this.causes == null) {this.causes = new java.util.ArrayList<V1StatusCauseBuilder>();}
  ...
  public A removeMatchingFromCauses(Predicate<io.kubernetes.client.openapi.models.V1StatusCauseBuilder> predicate) {
  ...
  public Boolean hasMatchingCause(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1StatusCauseBuilder> predicate) {
  ...
  class CausesNestedImpl<N> extends V1StatusCauseFluentImpl<V1StatusDetailsFluent.CausesNested<N>> implements io.kubernetes.client.openapi.models.V1StatusDetailsFluent.CausesNested<N>,Nested<N>{
