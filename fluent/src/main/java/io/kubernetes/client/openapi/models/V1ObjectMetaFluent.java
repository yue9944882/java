...
public interface V1ObjectMetaFluent<A extends V1ObjectMetaFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromManagedFields(java.util.function.Predicate<V1ManagedFieldsEntryBuilder> predicate);
  ...
  public A removeMatchingFromOwnerReferences(java.util.function.Predicate<V1OwnerReferenceBuilder> predicate);
