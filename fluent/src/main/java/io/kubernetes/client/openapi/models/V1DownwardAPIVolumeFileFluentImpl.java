...
import java.lang.Boolean;
  ...
  */
  ...
  class FieldRefNestedImpl<N> extends V1ObjectFieldSelectorFluentImpl<V1DownwardAPIVolumeFileFluent.FieldRefNested<N>> implements io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileFluent.FieldRefNested<N>,Nested<N>{
  ...
  class ResourceFieldRefNestedImpl<N> extends V1ResourceFieldSelectorFluentImpl<V1DownwardAPIVolumeFileFluent.ResourceFieldRefNested<N>> implements io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileFluent.ResourceFieldRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
