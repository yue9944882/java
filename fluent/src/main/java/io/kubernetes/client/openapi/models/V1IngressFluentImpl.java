...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1IngressSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1IngressSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1IngressStatus status) {
    ...
    if (status!=null){ this.status= new V1IngressStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1IngressFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1IngressFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1IngressSpecFluentImpl<V1IngressFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1IngressFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1IngressStatusFluentImpl<V1IngressFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1IngressFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
