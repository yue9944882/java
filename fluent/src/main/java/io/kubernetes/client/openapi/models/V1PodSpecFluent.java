...
public interface V1PodSpecFluent<A extends V1PodSpecFluent<A>> extends Fluent<A>{
  ...
  public V1PodSpec.DnsPolicyEnum getDnsPolicy();
  ...
  public A removeMatchingFromEphemeralContainers(java.util.function.Predicate<V1EphemeralContainerBuilder> predicate);
  ...
  public A removeMatchingFromHostAliases(java.util.function.Predicate<V1HostAliasBuilder> predicate);
  ...
  public A removeMatchingFromImagePullSecrets(java.util.function.Predicate<V1LocalObjectReferenceBuilder> predicate);
  ...
  public A removeMatchingFromReadinessGates(java.util.function.Predicate<V1PodReadinessGateBuilder> predicate);
  ...
  public A removeMatchingFromTolerations(java.util.function.Predicate<V1TolerationBuilder> predicate);
  ...
  public A removeMatchingFromTopologySpreadConstraints(java.util.function.Predicate<V1TopologySpreadConstraintBuilder> predicate);
  ...
  public interface EphemeralContainersNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1EphemeralContainerFluent<V1PodSpecFluent.EphemeralContainersNested<N>>{
    public N and();
  ...
  public interface OsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodOSFluent<V1PodSpecFluent.OsNested<N>>{
    public N and();
    public N endOs();
  ...
  public interface TopologySpreadConstraintsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TopologySpreadConstraintFluent<V1PodSpecFluent.TopologySpreadConstraintsNested<N>>{
    public N and();
