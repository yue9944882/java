...
import java.lang.Object;
  ...
  */
  ...
  public A withCurrent(io.kubernetes.client.openapi.models.V2MetricValueStatus current) {
    ...
    if (current!=null){ this.current= new V2MetricValueStatusBuilder(current); _visitables.get("current").add(this.current);} return (A) this;
  }
  ...
  class CurrentNestedImpl<N> extends V2MetricValueStatusFluentImpl<V2ObjectMetricStatusFluent.CurrentNested<N>> implements io.kubernetes.client.openapi.models.V2ObjectMetricStatusFluent.CurrentNested<N>,Nested<N>{
  ...
  class DescribedObjectNestedImpl<N> extends V2CrossVersionObjectReferenceFluentImpl<V2ObjectMetricStatusFluent.DescribedObjectNested<N>> implements io.kubernetes.client.openapi.models.V2ObjectMetricStatusFluent.DescribedObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class MetricNestedImpl<N> extends V2MetricIdentifierFluentImpl<V2ObjectMetricStatusFluent.MetricNested<N>> implements io.kubernetes.client.openapi.models.V2ObjectMetricStatusFluent.MetricNested<N>,io.kubernetes.client.fluent.Nested<N>{
