...
import java.lang.Object;
  ...
  */
  ...
  public A addAllToWebhooks(Collection<io.kubernetes.client.openapi.models.V1MutatingWebhook> items) {
    if (this.webhooks == null) {this.webhooks = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder>();}
    for (io.kubernetes.client.openapi.models.V1MutatingWebhook item : items) {io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder builder = new io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder(item);_visitables.get("webhooks").add(builder);this.webhooks.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromWebhooks(Predicate<io.kubernetes.client.openapi.models.V1MutatingWebhookBuilder> predicate) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1MutatingWebhookConfigurationFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.MetadataNested<N>,Nested<N>{
  ...
  class WebhooksNestedImpl<N> extends V1MutatingWebhookFluentImpl<V1MutatingWebhookConfigurationFluent.WebhooksNested<N>> implements io.kubernetes.client.openapi.models.V1MutatingWebhookConfigurationFluent.WebhooksNested<N>,io.kubernetes.client.fluent.Nested<N>{
