...
public class V1NodeConfigStatusBuilder extends V1NodeConfigStatusFluentImpl<V1NodeConfigStatusBuilder> implements VisitableBuilder<V1NodeConfigStatus,io.kubernetes.client.openapi.models.V1NodeConfigStatusBuilder>{
