...
public interface V1JobStatusFluent<A extends V1JobStatusFluent<A>> extends Fluent<A>{
  ...
  public interface UncountedTerminatedPodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1UncountedTerminatedPodsFluent<V1JobStatusFluent.UncountedTerminatedPodsNested<N>>{
    public N and();
