...
import java.lang.Object;
  ...
  */
  ...
  public A withObject(io.kubernetes.client.openapi.models.V2ObjectMetricStatus _object) {
    ...
    if (_object!=null){ this._object= new V2ObjectMetricStatusBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
  }
  ...
  class ContainerResourceNestedImpl<N> extends V2ContainerResourceMetricStatusFluentImpl<V2MetricStatusFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricStatusFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2ExternalMetricStatusFluentImpl<V2MetricStatusFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2MetricStatusFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2ObjectMetricStatusFluentImpl<V2MetricStatusFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2MetricStatusFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2PodsMetricStatusFluentImpl<V2MetricStatusFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2MetricStatusFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2ResourceMetricStatusFluentImpl<V2MetricStatusFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2MetricStatusFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
