...
import java.lang.Object;
  ...
  */
  ...
  public Boolean hasMatchingAdmissionReviewVersion(java.util.function.Predicate<java.lang.String> predicate) {
  ...
  public A withClientConfig(io.kubernetes.client.openapi.models.AdmissionregistrationV1WebhookClientConfig clientConfig) {
    ...
    if (clientConfig!=null){ this.clientConfig= new AdmissionregistrationV1WebhookClientConfigBuilder(clientConfig); _visitables.get("clientConfig").add(this.clientConfig);} return (A) this;
  }
  ...
  class ClientConfigNestedImpl<N> extends AdmissionregistrationV1WebhookClientConfigFluentImpl<V1ValidatingWebhookFluent.ClientConfigNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookFluent.ClientConfigNested<N>,Nested<N>{
  ...
  class NamespaceSelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1ValidatingWebhookFluent.NamespaceSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookFluent.NamespaceSelectorNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectSelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1ValidatingWebhookFluent.ObjectSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookFluent.ObjectSelectorNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class RulesNestedImpl<N> extends V1RuleWithOperationsFluentImpl<V1ValidatingWebhookFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1ValidatingWebhookFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
