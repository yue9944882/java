...
import java.lang.Object;
  ...
  */
  ...
  class ContainerResourceNestedImpl<N> extends V2beta2ContainerResourceMetricStatusFluentImpl<V2beta2MetricStatusFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricStatusFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2beta2ExternalMetricStatusFluentImpl<V2beta2MetricStatusFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricStatusFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2beta2ObjectMetricStatusFluentImpl<V2beta2MetricStatusFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricStatusFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2beta2PodsMetricStatusFluentImpl<V2beta2MetricStatusFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricStatusFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2beta2ResourceMetricStatusFluentImpl<V2beta2MetricStatusFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricStatusFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
