...
public interface V2beta1HorizontalPodAutoscalerStatusFluent<A extends V2beta1HorizontalPodAutoscalerStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromConditions(Predicate<V2beta1HorizontalPodAutoscalerConditionBuilder> predicate);
  ...
  public A removeMatchingFromCurrentMetrics(java.util.function.Predicate<V2beta1MetricStatusBuilder> predicate);
  ...
  public interface ConditionsNested<N> extends Nested<N>,V2beta1HorizontalPodAutoscalerConditionFluent<V2beta1HorizontalPodAutoscalerStatusFluent.ConditionsNested<N>>{
    public N and();
    public N endCondition();
    
  }
  public interface CurrentMetricsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1MetricStatusFluent<V2beta1HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>>{
    public N and();
