...
public class V1LeaseSpecBuilder extends V1LeaseSpecFluentImpl<V1LeaseSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1LeaseSpec,io.kubernetes.client.openapi.models.V1LeaseSpecBuilder>{
