...
import java.lang.Object;
  ...
  */
  ...
  public A addToConditions(Integer index,io.kubernetes.client.openapi.models.V1ComponentCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<V1ComponentConditionBuilder>();}
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1ComponentConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1ComponentConditionFluentImpl<V1ComponentStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ComponentStatusFluent.ConditionsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ComponentStatusFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ComponentStatusFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
