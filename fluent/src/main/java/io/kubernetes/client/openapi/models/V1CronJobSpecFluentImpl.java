...
import java.lang.Boolean;
  ...
  */
  ...
  private V1CronJobSpec.ConcurrencyPolicyEnum concurrencyPolicy;
  ...
  public A withJobTemplate(io.kubernetes.client.openapi.models.V1JobTemplateSpec jobTemplate) {
    ...
    if (jobTemplate!=null){ this.jobTemplate= new V1JobTemplateSpecBuilder(jobTemplate); _visitables.get("jobTemplate").add(this.jobTemplate);} return (A) this;
  }
  ...
  class JobTemplateNestedImpl<N> extends V1JobTemplateSpecFluentImpl<V1CronJobSpecFluent.JobTemplateNested<N>> implements io.kubernetes.client.openapi.models.V1CronJobSpecFluent.JobTemplateNested<N>,Nested<N>{
