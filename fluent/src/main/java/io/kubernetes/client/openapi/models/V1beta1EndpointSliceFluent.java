...
public interface V1beta1EndpointSliceFluent<A extends V1beta1EndpointSliceFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromPorts(java.util.function.Predicate<V1beta1EndpointPortBuilder> predicate);
  ...
  public interface EndpointsNested<N> extends Nested<N>,V1beta1EndpointFluent<V1beta1EndpointSliceFluent.EndpointsNested<N>>{
    public N and();
