...
public class V1LimitRangeSpecBuilder extends V1LimitRangeSpecFluentImpl<V1LimitRangeSpecBuilder> implements VisitableBuilder<V1LimitRangeSpec,io.kubernetes.client.openapi.models.V1LimitRangeSpecBuilder>{
