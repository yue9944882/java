...
public class V1RollingUpdateDeploymentBuilder extends V1RollingUpdateDeploymentFluentImpl<V1RollingUpdateDeploymentBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1RollingUpdateDeployment,io.kubernetes.client.openapi.models.V1RollingUpdateDeploymentBuilder>{
