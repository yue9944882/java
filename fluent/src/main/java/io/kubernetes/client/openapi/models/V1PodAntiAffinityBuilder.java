...
public class V1PodAntiAffinityBuilder extends V1PodAntiAffinityFluentImpl<V1PodAntiAffinityBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1PodAntiAffinity,V1PodAntiAffinityBuilder>{
