...
public class V2HPAScalingPolicyBuilder extends V2HPAScalingPolicyFluentImpl<V2HPAScalingPolicyBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V2HPAScalingPolicy,io.kubernetes.client.openapi.models.V2HPAScalingPolicyBuilder>{
