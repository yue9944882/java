...
import java.lang.Integer;
  ...
  */
  ...
  private V1EphemeralContainer.ImagePullPolicyEnum imagePullPolicy;
  ...
  private V1EphemeralContainer.TerminationMessagePolicyEnum terminationMessagePolicy;
  ...
  public A addToEnv(java.lang.Integer index,io.kubernetes.client.openapi.models.V1EnvVar item) {
    if (this.env == null) {this.env = new java.util.ArrayList<V1EnvVarBuilder>();}
  ...
  public A addToVolumeMounts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1VolumeMount item) {
    if (this.volumeMounts == null) {this.volumeMounts = new java.util.ArrayList<V1VolumeMountBuilder>();}
  ...
  class EnvNestedImpl<N> extends V1EnvVarFluentImpl<V1EphemeralContainerFluent.EnvNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.EnvNested<N>,Nested<N>{
  ...
  class EnvFromNestedImpl<N> extends V1EnvFromSourceFluentImpl<V1EphemeralContainerFluent.EnvFromNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.EnvFromNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class LifecycleNestedImpl<N> extends V1LifecycleFluentImpl<V1EphemeralContainerFluent.LifecycleNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.LifecycleNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class LivenessProbeNestedImpl<N> extends V1ProbeFluentImpl<V1EphemeralContainerFluent.LivenessProbeNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.LivenessProbeNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PortsNestedImpl<N> extends V1ContainerPortFluentImpl<V1EphemeralContainerFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ReadinessProbeNestedImpl<N> extends V1ProbeFluentImpl<V1EphemeralContainerFluent.ReadinessProbeNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.ReadinessProbeNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourcesNestedImpl<N> extends V1ResourceRequirementsFluentImpl<V1EphemeralContainerFluent.ResourcesNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.ResourcesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SecurityContextNestedImpl<N> extends V1SecurityContextFluentImpl<V1EphemeralContainerFluent.SecurityContextNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.SecurityContextNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StartupProbeNestedImpl<N> extends V1ProbeFluentImpl<V1EphemeralContainerFluent.StartupProbeNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.StartupProbeNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class VolumeDevicesNestedImpl<N> extends V1VolumeDeviceFluentImpl<V1EphemeralContainerFluent.VolumeDevicesNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.VolumeDevicesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class VolumeMountsNestedImpl<N> extends V1VolumeMountFluentImpl<V1EphemeralContainerFluent.VolumeMountsNested<N>> implements io.kubernetes.client.openapi.models.V1EphemeralContainerFluent.VolumeMountsNested<N>,io.kubernetes.client.fluent.Nested<N>{
