...
import java.util.Map;
  ...
  */
  ...
  private V1ServiceSpec.ExternalTrafficPolicyEnum externalTrafficPolicy;
  ...
  private V1ServiceSpec.TypeEnum type;
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ServicePort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<V1ServicePortBuilder>();}
  ...
  public A withSessionAffinityConfig(io.kubernetes.client.openapi.models.V1SessionAffinityConfig sessionAffinityConfig) {
    ...
    if (sessionAffinityConfig!=null){ this.sessionAffinityConfig= new V1SessionAffinityConfigBuilder(sessionAffinityConfig); _visitables.get("sessionAffinityConfig").add(this.sessionAffinityConfig);} return (A) this;
  }
  ...
  class PortsNestedImpl<N> extends V1ServicePortFluentImpl<V1ServiceSpecFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceSpecFluent.PortsNested<N>,Nested<N>{
  ...
  class SessionAffinityConfigNestedImpl<N> extends V1SessionAffinityConfigFluentImpl<V1ServiceSpecFluent.SessionAffinityConfigNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceSpecFluent.SessionAffinityConfigNested<N>,io.kubernetes.client.fluent.Nested<N>{
