...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1EventListFluentImpl<A extends V1beta1EventListFluent<A>> extends BaseFluent<A> implements V1beta1EventListFluent<A>{
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1beta1EventBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V1beta1EventFluentImpl<V1beta1EventListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta1EventListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EventListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
