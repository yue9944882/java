...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFile item) {
    if (this.items == null) {this.items = new java.util.ArrayList<V1DownwardAPIVolumeFileBuilder>();}
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1DownwardAPIVolumeFileBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V1DownwardAPIVolumeFileFluentImpl<V1DownwardAPIProjectionFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1DownwardAPIProjectionFluent.ItemsNested<N>,Nested<N>{
