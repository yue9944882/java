...
public class V1PolicyRuleBuilder extends V1PolicyRuleFluentImpl<V1PolicyRuleBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1PolicyRule,V1PolicyRuleBuilder>{
