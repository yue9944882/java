...
public interface V1EndpointSliceListFluent<A extends V1EndpointSliceListFluent<A>> extends Fluent<A>{
  ...
  public V1EndpointSliceListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1EndpointSlice item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1EndpointSliceListFluent.MetadataNested<N>>{
    public N and();
