...
public interface V2beta2ObjectMetricSourceFluent<A extends V2beta2ObjectMetricSourceFluent<A>> extends Fluent<A>{
  ...
  public interface MetricNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricIdentifierFluent<V2beta2ObjectMetricSourceFluent.MetricNested<N>>{
    public N and();
    public N endMetric();
    
  }
  public interface TargetNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricTargetFluent<V2beta2ObjectMetricSourceFluent.TargetNested<N>>{
    public N and();
    public N endTarget();
