...
public interface V1SubjectRulesReviewStatusFluent<A extends V1SubjectRulesReviewStatusFluent<A>> extends Fluent<A>{
  ...
  public A removeMatchingFromResourceRules(java.util.function.Predicate<V1ResourceRuleBuilder> predicate);
  ...
  public interface ResourceRulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ResourceRuleFluent<V1SubjectRulesReviewStatusFluent.ResourceRulesNested<N>>{
    public N and();
