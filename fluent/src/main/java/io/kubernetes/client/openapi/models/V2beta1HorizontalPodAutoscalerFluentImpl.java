...
import java.lang.Object;
  ...
  */
  ...
  public class V2beta1HorizontalPodAutoscalerFluentImpl<A extends V2beta1HorizontalPodAutoscalerFluent<A>> extends BaseFluent<A> implements V2beta1HorizontalPodAutoscalerFluent<A>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V2beta1HorizontalPodAutoscalerFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V2beta1HorizontalPodAutoscalerSpecFluentImpl<V2beta1HorizontalPodAutoscalerFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V2beta1HorizontalPodAutoscalerStatusFluentImpl<V2beta1HorizontalPodAutoscalerFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
