...
public interface V1NetworkPolicyPeerFluent<A extends V1NetworkPolicyPeerFluent<A>> extends Fluent<A>{
  ...
  public interface NamespaceSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1NetworkPolicyPeerFluent.NamespaceSelectorNested<N>>{
    public N and();
    public N endNamespaceSelector();
    
  }
  public interface PodSelectorNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1NetworkPolicyPeerFluent.PodSelectorNested<N>>{
    public N and();
