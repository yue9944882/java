...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1NodeSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1NodeSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1NodeStatus status) {
    ...
    if (status!=null){ this.status= new V1NodeStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1NodeFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1NodeFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1NodeSpecFluentImpl<V1NodeFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1NodeFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1NodeStatusFluentImpl<V1NodeFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1NodeFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
