...
public class V1FCVolumeSourceBuilder extends V1FCVolumeSourceFluentImpl<V1FCVolumeSourceBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1FCVolumeSource,V1FCVolumeSourceBuilder>{
