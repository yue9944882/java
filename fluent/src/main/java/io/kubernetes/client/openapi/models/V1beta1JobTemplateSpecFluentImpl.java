...
import java.lang.Boolean;
  ...
  */
  ...
  public V1beta1JobTemplateSpecFluent.MetadataNested<A> withNewMetadata() {
    return new V1beta1JobTemplateSpecFluentImpl.MetadataNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item) {
    return new V1beta1JobTemplateSpecFluentImpl.MetadataNestedImpl(item);
  }
  ...
  public V1beta1JobTemplateSpecFluent.SpecNested<A> withNewSpec() {
    return new V1beta1JobTemplateSpecFluentImpl.SpecNestedImpl();
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1JobTemplateSpecFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1JobSpecFluentImpl<V1beta1JobTemplateSpecFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta1JobTemplateSpecFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
