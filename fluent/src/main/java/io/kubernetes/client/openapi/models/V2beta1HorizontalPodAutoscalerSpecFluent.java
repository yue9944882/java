...
public interface V2beta1HorizontalPodAutoscalerSpecFluent<A extends V2beta1HorizontalPodAutoscalerSpecFluent<A>> extends Fluent<A>{
  ...
  public interface MetricsNested<N> extends Nested<N>,V2beta1MetricSpecFluent<V2beta1HorizontalPodAutoscalerSpecFluent.MetricsNested<N>>{
    public N and();
    public N endMetric();
    
  }
  public interface ScaleTargetRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1CrossVersionObjectReferenceFluent<V2beta1HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>>{
    public N and();
