...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1SelfSubjectAccessReviewSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1SelfSubjectAccessReviewFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1SelfSubjectAccessReviewSpecFluentImpl<V1SelfSubjectAccessReviewFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1SubjectAccessReviewStatusFluentImpl<V1SelfSubjectAccessReviewFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
