...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1EndpointSliceFluentImpl<A extends V1beta1EndpointSliceFluent<A>> extends BaseFluent<A> implements V1beta1EndpointSliceFluent<A>{
  ...
  public A removeMatchingFromEndpoints(Predicate<io.kubernetes.client.openapi.models.V1beta1EndpointBuilder> predicate) {
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<V1beta1EndpointPortBuilder>();}
  ...
  class EndpointsNestedImpl<N> extends V1beta1EndpointFluentImpl<V1beta1EndpointSliceFluent.EndpointsNested<N>> implements V1beta1EndpointSliceFluent.EndpointsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1EndpointSliceFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PortsNestedImpl<N> extends V1beta1EndpointPortFluentImpl<V1beta1EndpointSliceFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1beta1EndpointSliceFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
