...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1beta1PodDisruptionBudgetListFluent<A extends V1beta1PodDisruptionBudgetListFluent<A>> extends Fluent<A>{
  ...
  public interface ItemsNested<N> extends Nested<N>,V1beta1PodDisruptionBudgetFluent<V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>>{
    public N and();
    public N endItem();
    
  }
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1beta1PodDisruptionBudgetListFluent.MetadataNested<N>>{
    public N and();
