...
public class V1ConfigMapBuilder extends V1ConfigMapFluentImpl<V1ConfigMapBuilder> implements VisitableBuilder<V1ConfigMap,io.kubernetes.client.openapi.models.V1ConfigMapBuilder>{
