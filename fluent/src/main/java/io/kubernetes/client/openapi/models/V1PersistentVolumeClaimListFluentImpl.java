...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1PersistentVolumeClaim> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder>();}
    for (io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item : items) {io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder builder = new io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1PersistentVolumeClaimBuilder> predicate) {
  ...
  public V1PersistentVolumeClaimListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1PersistentVolumeClaim item) {
  ...
  class ItemsNestedImpl<N> extends V1PersistentVolumeClaimFluentImpl<V1PersistentVolumeClaimListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1PersistentVolumeClaimListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
