...
public class V1IPBlockBuilder extends V1IPBlockFluentImpl<V1IPBlockBuilder> implements VisitableBuilder<V1IPBlock,io.kubernetes.client.openapi.models.V1IPBlockBuilder>{
