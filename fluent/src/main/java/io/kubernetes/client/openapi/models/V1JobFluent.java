...
public interface V1JobFluent<A extends V1JobFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JobSpecFluent<V1JobFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1JobStatusFluent<V1JobFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
