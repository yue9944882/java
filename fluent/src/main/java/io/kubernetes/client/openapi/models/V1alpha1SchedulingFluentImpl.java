...
import java.util.Map;
  ...
  */
  ...
  public class V1alpha1SchedulingFluentImpl<A extends V1alpha1SchedulingFluent<A>> extends BaseFluent<A> implements V1alpha1SchedulingFluent<A>{
  ...
  public A removeMatchingFromTolerations(Predicate<io.kubernetes.client.openapi.models.V1TolerationBuilder> predicate) {
  ...
  class TolerationsNestedImpl<N> extends V1TolerationFluentImpl<V1alpha1SchedulingFluent.TolerationsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1SchedulingFluent.TolerationsNested<N>,Nested<N>{
