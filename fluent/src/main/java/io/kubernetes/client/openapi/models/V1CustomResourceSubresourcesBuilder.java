...
public class V1CustomResourceSubresourcesBuilder extends V1CustomResourceSubresourcesFluentImpl<V1CustomResourceSubresourcesBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1CustomResourceSubresources,V1CustomResourceSubresourcesBuilder>{
