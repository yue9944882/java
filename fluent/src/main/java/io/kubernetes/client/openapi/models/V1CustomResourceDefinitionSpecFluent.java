...
public interface V1CustomResourceDefinitionSpecFluent<A extends V1CustomResourceDefinitionSpecFluent<A>> extends Fluent<A>{
  ...
  public interface NamesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CustomResourceDefinitionNamesFluent<V1CustomResourceDefinitionSpecFluent.NamesNested<N>>{
    public N and();
    public N endNames();
    
  }
  public interface VersionsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CustomResourceDefinitionVersionFluent<V1CustomResourceDefinitionSpecFluent.VersionsNested<N>>{
    public N and();
    public N endVersion();
