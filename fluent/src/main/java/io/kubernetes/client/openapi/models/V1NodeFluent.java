...
public interface V1NodeFluent<A extends V1NodeFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NodeSpecFluent<V1NodeFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NodeStatusFluent<V1NodeFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
