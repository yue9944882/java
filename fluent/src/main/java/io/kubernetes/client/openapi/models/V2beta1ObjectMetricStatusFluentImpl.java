...
import java.lang.Boolean;
  ...
  */
  ...
  public class V2beta1ObjectMetricStatusFluentImpl<A extends V2beta1ObjectMetricStatusFluent<A>> extends BaseFluent<A> implements V2beta1ObjectMetricStatusFluent<A>{
  ...
  class SelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V2beta1ObjectMetricStatusFluent.SelectorNested<N>> implements io.kubernetes.client.openapi.models.V2beta1ObjectMetricStatusFluent.SelectorNested<N>,Nested<N>{
  ...
  class TargetNestedImpl<N> extends V2beta1CrossVersionObjectReferenceFluentImpl<V2beta1ObjectMetricStatusFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2beta1ObjectMetricStatusFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N>{
