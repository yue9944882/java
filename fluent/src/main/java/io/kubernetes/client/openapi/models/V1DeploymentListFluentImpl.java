...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1DeploymentBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V1DeploymentFluentImpl<V1DeploymentListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1DeploymentListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
