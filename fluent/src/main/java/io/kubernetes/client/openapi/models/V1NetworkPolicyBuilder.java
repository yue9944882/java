...
public class V1NetworkPolicyBuilder extends V1NetworkPolicyFluentImpl<V1NetworkPolicyBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1NetworkPolicy,V1NetworkPolicyBuilder>{
