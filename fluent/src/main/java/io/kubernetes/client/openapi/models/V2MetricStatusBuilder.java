...
public class V2MetricStatusBuilder extends V2MetricStatusFluentImpl<V2MetricStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V2MetricStatus,io.kubernetes.client.openapi.models.V2MetricStatusBuilder>{
