...
public class V1ReplicaSetBuilder extends V1ReplicaSetFluentImpl<V1ReplicaSetBuilder> implements VisitableBuilder<V1ReplicaSet,io.kubernetes.client.openapi.models.V1ReplicaSetBuilder>{
