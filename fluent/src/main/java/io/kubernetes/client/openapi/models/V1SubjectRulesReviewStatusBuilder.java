...
public class V1SubjectRulesReviewStatusBuilder extends V1SubjectRulesReviewStatusFluentImpl<V1SubjectRulesReviewStatusBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1SubjectRulesReviewStatus,V1SubjectRulesReviewStatusBuilder>{
