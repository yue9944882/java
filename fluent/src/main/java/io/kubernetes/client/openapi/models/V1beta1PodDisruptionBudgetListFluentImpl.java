...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1PodDisruptionBudgetListFluentImpl<A extends V1beta1PodDisruptionBudgetListFluent<A>> extends BaseFluent<A> implements V1beta1PodDisruptionBudgetListFluent<A>{
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder>();}
    for (io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget item : items) {io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder builder = new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V1beta1PodDisruptionBudgetFluentImpl<V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>> implements V1beta1PodDisruptionBudgetListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1beta1PodDisruptionBudgetListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
