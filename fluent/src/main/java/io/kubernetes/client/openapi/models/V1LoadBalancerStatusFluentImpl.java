...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToIngress(Integer index,io.kubernetes.client.openapi.models.V1LoadBalancerIngress item) {
    if (this.ingress == null) {this.ingress = new java.util.ArrayList<V1LoadBalancerIngressBuilder>();}
  ...
  public A removeMatchingFromIngress(Predicate<io.kubernetes.client.openapi.models.V1LoadBalancerIngressBuilder> predicate) {
  ...
  class IngressNestedImpl<N> extends V1LoadBalancerIngressFluentImpl<V1LoadBalancerStatusFluent.IngressNested<N>> implements io.kubernetes.client.openapi.models.V1LoadBalancerStatusFluent.IngressNested<N>,Nested<N>{
