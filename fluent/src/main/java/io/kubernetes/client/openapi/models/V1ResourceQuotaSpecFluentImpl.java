...
import java.util.Map;
  ...
  */
  ...
  public A addToScopes(Integer index,java.lang.String item) {
    if (this.scopes == null) {this.scopes = new ArrayList<java.lang.String>();}
  ...
  class ScopeSelectorNestedImpl<N> extends V1ScopeSelectorFluentImpl<V1ResourceQuotaSpecFluent.ScopeSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaSpecFluent.ScopeSelectorNested<N>,Nested<N>{
