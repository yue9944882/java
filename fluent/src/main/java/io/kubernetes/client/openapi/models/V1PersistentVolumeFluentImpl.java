...
import java.lang.Object;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1PersistentVolumeFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1PersistentVolumeSpecFluentImpl<V1PersistentVolumeFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1PersistentVolumeStatusFluentImpl<V1PersistentVolumeFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
