...
public class V2HorizontalPodAutoscalerListBuilder extends V2HorizontalPodAutoscalerListFluentImpl<V2HorizontalPodAutoscalerListBuilder> implements VisitableBuilder<V2HorizontalPodAutoscalerList,io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerListBuilder>{
