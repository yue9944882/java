...
import java.lang.Object;
  ...
  */
  ...
  public A addAllToConditions(Collection<io.kubernetes.client.openapi.models.V1alpha1StorageVersionCondition> items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1alpha1StorageVersionConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1alpha1StorageVersionCondition item : items) {io.kubernetes.client.openapi.models.V1alpha1StorageVersionConditionBuilder builder = new io.kubernetes.client.openapi.models.V1alpha1StorageVersionConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1alpha1StorageVersionConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1alpha1StorageVersionConditionFluentImpl<V1alpha1StorageVersionStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1StorageVersionStatusFluent.ConditionsNested<N>,Nested<N>{
  ...
  class StorageVersionsNestedImpl<N> extends V1alpha1ServerStorageVersionFluentImpl<V1alpha1StorageVersionStatusFluent.StorageVersionsNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1StorageVersionStatusFluent.StorageVersionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
