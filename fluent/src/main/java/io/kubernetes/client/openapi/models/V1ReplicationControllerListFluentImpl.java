...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1ReplicationController item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1ReplicationController> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ReplicationController item : items) {io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder builder = new io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1ReplicationControllerBuilder> predicate) {
  ...
  public V1ReplicationControllerListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ReplicationController item) {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ReplicationControllerListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicationControllerListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
