...
public class V1StatefulSetBuilder extends V1StatefulSetFluentImpl<V1StatefulSetBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1StatefulSet,V1StatefulSetBuilder>{
