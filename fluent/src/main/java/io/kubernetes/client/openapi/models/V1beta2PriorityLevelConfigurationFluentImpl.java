...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1beta2PriorityLevelConfigurationSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationStatus status) {
    ...
    if (status!=null){ this.status= new V1beta2PriorityLevelConfigurationStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta2PriorityLevelConfigurationFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1beta2PriorityLevelConfigurationSpecFluentImpl<V1beta2PriorityLevelConfigurationFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1beta2PriorityLevelConfigurationStatusFluentImpl<V1beta2PriorityLevelConfigurationFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
