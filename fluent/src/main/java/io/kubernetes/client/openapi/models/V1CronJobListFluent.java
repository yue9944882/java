...
public interface V1CronJobListFluent<A extends V1CronJobListFluent<A>> extends Fluent<A>{
  ...
  public V1CronJobListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1CronJob item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1CronJobListFluent.MetadataNested<N>>{
    public N and();
