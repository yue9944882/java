...
public class V1JobSpecBuilder extends V1JobSpecFluentImpl<V1JobSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1JobSpec,V1JobSpecBuilder>{
