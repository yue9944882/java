...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1alpha1CSIStorageCapacityFluentImpl<A extends V1alpha1CSIStorageCapacityFluent<A>> extends BaseFluent<A> implements V1alpha1CSIStorageCapacityFluent<A>{
  ...
  public A withNodeTopology(io.kubernetes.client.openapi.models.V1LabelSelector nodeTopology) {
    ...
    if (nodeTopology!=null){ this.nodeTopology= new V1LabelSelectorBuilder(nodeTopology); _visitables.get("nodeTopology").add(this.nodeTopology);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1alpha1CSIStorageCapacityFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.MetadataNested<N>,Nested<N>{
  ...
  class NodeTopologyNestedImpl<N> extends V1LabelSelectorFluentImpl<V1alpha1CSIStorageCapacityFluent.NodeTopologyNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityFluent.NodeTopologyNested<N>,io.kubernetes.client.fluent.Nested<N>{
