...
public interface V1TokenReviewFluent<A extends V1TokenReviewFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TokenReviewSpecFluent<V1TokenReviewFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TokenReviewStatusFluent<V1TokenReviewFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
