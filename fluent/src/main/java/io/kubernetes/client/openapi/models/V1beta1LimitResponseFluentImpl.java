...
import java.lang.Boolean;
  ...
  */
  ...
  public A withQueuing(io.kubernetes.client.openapi.models.V1beta1QueuingConfiguration queuing) {
    ...
    if (queuing!=null){ this.queuing= new V1beta1QueuingConfigurationBuilder(queuing); _visitables.get("queuing").add(this.queuing);} return (A) this;
  }
  ...
  class QueuingNestedImpl<N> extends V1beta1QueuingConfigurationFluentImpl<V1beta1LimitResponseFluent.QueuingNested<N>> implements io.kubernetes.client.openapi.models.V1beta1LimitResponseFluent.QueuingNested<N>,Nested<N>{
