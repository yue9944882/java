...
import java.lang.Object;
  ...
  */
  ...
  class SelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1DaemonSetSpecFluent.SelectorNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetSpecFluent.SelectorNested<N>,Nested<N>{
  ...
  class TemplateNestedImpl<N> extends V1PodTemplateSpecFluentImpl<V1DaemonSetSpecFluent.TemplateNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetSpecFluent.TemplateNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class UpdateStrategyNestedImpl<N> extends V1DaemonSetUpdateStrategyFluentImpl<V1DaemonSetSpecFluent.UpdateStrategyNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetSpecFluent.UpdateStrategyNested<N>,io.kubernetes.client.fluent.Nested<N>{
