...
public interface V2beta2ExternalMetricSourceFluent<A extends V2beta2ExternalMetricSourceFluent<A>> extends Fluent<A>{
  ...
  public interface TargetNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricTargetFluent<V2beta2ExternalMetricSourceFluent.TargetNested<N>>{
    public N and();
    public N endTarget();
