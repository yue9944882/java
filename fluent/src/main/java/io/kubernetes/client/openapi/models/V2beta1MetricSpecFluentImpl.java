...
import java.lang.Object;
  ...
  */
  ...
  public A withObject(io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource _object) {
    ...
    if (_object!=null){ this._object= new V2beta1ObjectMetricSourceBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
  }
  ...
  public A withPods(io.kubernetes.client.openapi.models.V2beta1PodsMetricSource pods) {
    ...
    if (pods!=null){ this.pods= new V2beta1PodsMetricSourceBuilder(pods); _visitables.get("pods").add(this.pods);} return (A) this;
  }
  ...
  public A withResource(io.kubernetes.client.openapi.models.V2beta1ResourceMetricSource resource) {
    ...
    if (resource!=null){ this.resource= new V2beta1ResourceMetricSourceBuilder(resource); _visitables.get("resource").add(this.resource);} return (A) this;
  }
  ...
  class ContainerResourceNestedImpl<N> extends V2beta1ContainerResourceMetricSourceFluentImpl<V2beta1MetricSpecFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2beta1ExternalMetricSourceFluentImpl<V2beta1MetricSpecFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2beta1ObjectMetricSourceFluentImpl<V2beta1MetricSpecFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2beta1PodsMetricSourceFluentImpl<V2beta1MetricSpecFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2beta1ResourceMetricSourceFluentImpl<V2beta1MetricSpecFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricSpecFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
