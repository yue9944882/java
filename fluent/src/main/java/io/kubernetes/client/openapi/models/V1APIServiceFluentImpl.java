...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1APIServiceStatus status) {
    ...
    if (status!=null){ this.status= new V1APIServiceStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1APIServiceFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1APIServiceSpecFluentImpl<V1APIServiceFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1APIServiceStatusFluentImpl<V1APIServiceFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1APIServiceFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
