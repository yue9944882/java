...
import java.lang.Boolean;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1LeaseSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1LeaseSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1LeaseFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1LeaseFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1LeaseSpecFluentImpl<V1LeaseFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1LeaseFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
