...
public interface V1RoleListFluent<A extends V1RoleListFluent<A>> extends Fluent<A>{
  ...
  public V1RoleListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1Role item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1RoleListFluent.MetadataNested<N>>{
    public N and();
