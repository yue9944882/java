...
import java.lang.Boolean;
  ...
  * Generated
  */
public interface V1alpha1CSIStorageCapacityFluent<A extends V1alpha1CSIStorageCapacityFluent<A>> extends Fluent<A>{
  ...
  public interface MetadataNested<N> extends Nested<N>,V1ObjectMetaFluent<V1alpha1CSIStorageCapacityFluent.MetadataNested<N>>{
    public N and();
    public N endMetadata();
    
  }
  public interface NodeTopologyNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1LabelSelectorFluent<V1alpha1CSIStorageCapacityFluent.NodeTopologyNested<N>>{
    public N and();
