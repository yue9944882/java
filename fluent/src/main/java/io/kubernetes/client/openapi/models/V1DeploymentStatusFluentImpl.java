...
import java.lang.Boolean;
  ...
  */
  ...
  public A addAllToConditions(Collection<io.kubernetes.client.openapi.models.V1DeploymentCondition> items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1DeploymentCondition item : items) {io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder builder = new io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1DeploymentConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1DeploymentConditionFluentImpl<V1DeploymentStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1DeploymentStatusFluent.ConditionsNested<N>,Nested<N>{
