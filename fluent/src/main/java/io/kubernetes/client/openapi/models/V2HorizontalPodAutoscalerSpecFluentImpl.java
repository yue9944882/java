...
import java.lang.Object;
  ...
  */
  ...
  public A withBehavior(io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerBehavior behavior) {
    ...
    if (behavior!=null){ this.behavior= new V2HorizontalPodAutoscalerBehaviorBuilder(behavior); _visitables.get("behavior").add(this.behavior);} return (A) this;
  }
  ...
  public A addToMetrics(java.lang.Integer index,io.kubernetes.client.openapi.models.V2MetricSpec item) {
    if (this.metrics == null) {this.metrics = new java.util.ArrayList<V2MetricSpecBuilder>();}
  ...
  public A removeMatchingFromMetrics(Predicate<io.kubernetes.client.openapi.models.V2MetricSpecBuilder> predicate) {
  ...
  class BehaviorNestedImpl<N> extends V2HorizontalPodAutoscalerBehaviorFluentImpl<V2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.BehaviorNested<N>,Nested<N>{
  ...
  class MetricsNestedImpl<N> extends V2MetricSpecFluentImpl<V2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.MetricsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ScaleTargetRefNestedImpl<N> extends V2CrossVersionObjectReferenceFluentImpl<V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>> implements io.kubernetes.client.openapi.models.V2HorizontalPodAutoscalerSpecFluent.ScaleTargetRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
