...
public class V1EndpointBuilder extends V1EndpointFluentImpl<V1EndpointBuilder> implements VisitableBuilder<V1Endpoint,io.kubernetes.client.openapi.models.V1EndpointBuilder>{
