...
public interface V2beta2ObjectMetricStatusFluent<A extends V2beta2ObjectMetricStatusFluent<A>> extends Fluent<A>{
  ...
  public interface DescribedObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2CrossVersionObjectReferenceFluent<V2beta2ObjectMetricStatusFluent.DescribedObjectNested<N>>{
    public N and();
    public N endDescribedObject();
    
  }
  public interface MetricNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2MetricIdentifierFluent<V2beta2ObjectMetricStatusFluent.MetricNested<N>>{
    public N and();
    public N endMetric();
