...
import java.lang.Boolean;
  ...
  */
  ...
  class NonResourceAttributesNestedImpl<N> extends V1NonResourceAttributesFluentImpl<V1SelfSubjectAccessReviewSpecFluent.NonResourceAttributesNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewSpecFluent.NonResourceAttributesNested<N>,Nested<N>{
  ...
  class ResourceAttributesNestedImpl<N> extends V1ResourceAttributesFluentImpl<V1SelfSubjectAccessReviewSpecFluent.ResourceAttributesNested<N>> implements io.kubernetes.client.openapi.models.V1SelfSubjectAccessReviewSpecFluent.ResourceAttributesNested<N>,io.kubernetes.client.fluent.Nested<N>{
