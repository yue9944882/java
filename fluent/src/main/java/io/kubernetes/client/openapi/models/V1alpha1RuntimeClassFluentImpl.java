...
import java.lang.Boolean;
  ...
  */
  ...
  public class V1alpha1RuntimeClassFluentImpl<A extends V1alpha1RuntimeClassFluent<A>> extends BaseFluent<A> implements V1alpha1RuntimeClassFluent<A>{
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1alpha1RuntimeClassSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1alpha1RuntimeClassFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1alpha1RuntimeClassSpecFluentImpl<V1alpha1RuntimeClassFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
