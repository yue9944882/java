...
import java.lang.Object;
  ...
  */
  ...
  public A withUser(io.kubernetes.client.openapi.models.V1beta1UserSubject user) {
    ...
    if (user!=null){ this.user= new V1beta1UserSubjectBuilder(user); _visitables.get("user").add(this.user);} return (A) this;
  }
  ...
  class GroupNestedImpl<N> extends V1beta1GroupSubjectFluentImpl<V1beta1SubjectFluent.GroupNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.GroupNested<N>,Nested<N>{
  ...
  class ServiceAccountNestedImpl<N> extends V1beta1ServiceAccountSubjectFluentImpl<V1beta1SubjectFluent.ServiceAccountNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.ServiceAccountNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class UserNestedImpl<N> extends V1beta1UserSubjectFluentImpl<V1beta1SubjectFluent.UserNested<N>> implements io.kubernetes.client.openapi.models.V1beta1SubjectFluent.UserNested<N>,io.kubernetes.client.fluent.Nested<N>{
