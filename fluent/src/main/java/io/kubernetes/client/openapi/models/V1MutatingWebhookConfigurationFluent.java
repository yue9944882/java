...
public interface V1MutatingWebhookConfigurationFluent<A extends V1MutatingWebhookConfigurationFluent<A>> extends Fluent<A>{
  ...
  public V1MutatingWebhookConfigurationFluent.MetadataNested<A> withNewMetadataLike(io.kubernetes.client.openapi.models.V1ObjectMeta item);
  ...
  public interface WebhooksNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1MutatingWebhookFluent<V1MutatingWebhookConfigurationFluent.WebhooksNested<N>>{
    public N and();
    public N endWebhook();
