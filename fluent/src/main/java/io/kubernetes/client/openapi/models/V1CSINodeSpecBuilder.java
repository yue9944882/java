...
public class V1CSINodeSpecBuilder extends V1CSINodeSpecFluentImpl<V1CSINodeSpecBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1CSINodeSpec,io.kubernetes.client.openapi.models.V1CSINodeSpecBuilder>{
