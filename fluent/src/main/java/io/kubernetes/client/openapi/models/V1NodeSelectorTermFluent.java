...
public interface V1NodeSelectorTermFluent<A extends V1NodeSelectorTermFluent<A>> extends Fluent<A>{
  ...
  public interface MatchFieldsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1NodeSelectorRequirementFluent<V1NodeSelectorTermFluent.MatchFieldsNested<N>>{
    public N and();
