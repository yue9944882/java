...
import java.lang.Boolean;
  ...
  */
  ...
  private V1ScopedResourceSelectorRequirement.OperatorEnum operator;
  private V1ScopedResourceSelectorRequirement.ScopeNameEnum scopeName;
  ...
  public A addToValues(Integer index,java.lang.String item) {
    if (this.values == null) {this.values = new ArrayList<java.lang.String>();}
