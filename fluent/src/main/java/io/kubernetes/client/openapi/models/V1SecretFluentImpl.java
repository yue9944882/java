...
import java.util.Map;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1SecretFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1SecretFluent.MetadataNested<N>,Nested<N>{
