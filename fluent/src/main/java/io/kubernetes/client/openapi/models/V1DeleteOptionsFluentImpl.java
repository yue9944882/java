...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToDryRun(Integer index,java.lang.String item) {
    if (this.dryRun == null) {this.dryRun = new ArrayList<java.lang.String>();}
  ...
  class PreconditionsNestedImpl<N> extends V1PreconditionsFluentImpl<V1DeleteOptionsFluent.PreconditionsNested<N>> implements io.kubernetes.client.openapi.models.V1DeleteOptionsFluent.PreconditionsNested<N>,Nested<N>{
