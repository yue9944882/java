...
import java.lang.Boolean;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1CSIDriverSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1CSIDriverSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1CSIDriverFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1CSIDriverSpecFluentImpl<V1CSIDriverFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1CSIDriverFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
