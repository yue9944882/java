...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1CronJobFluentImpl<A extends V1beta1CronJobFluent<A>> extends BaseFluent<A> implements V1beta1CronJobFluent<A>{
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1beta1CronJobStatus status) {
    ...
    if (status!=null){ this.status= new V1beta1CronJobStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1CronJobFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1beta1CronJobSpecFluentImpl<V1beta1CronJobFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1beta1CronJobStatusFluentImpl<V1beta1CronJobFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1beta1CronJobFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
