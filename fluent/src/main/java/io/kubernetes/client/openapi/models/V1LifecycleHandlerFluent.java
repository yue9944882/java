...
public interface V1LifecycleHandlerFluent<A extends V1LifecycleHandlerFluent<A>> extends Fluent<A>{
  ...
  public interface HttpGetNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1HTTPGetActionFluent<V1LifecycleHandlerFluent.HttpGetNested<N>>{
    public N and();
    public N endHttpGet();
    
  }
  public interface TcpSocketNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1TCPSocketActionFluent<V1LifecycleHandlerFluent.TcpSocketNested<N>>{
    public N and();
