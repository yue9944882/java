...
public class V1PodDisruptionBudgetBuilder extends V1PodDisruptionBudgetFluentImpl<V1PodDisruptionBudgetBuilder> implements VisitableBuilder<V1PodDisruptionBudget,io.kubernetes.client.openapi.models.V1PodDisruptionBudgetBuilder>{
