...
import java.lang.Object;
  ...
  */
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1StatefulSetStatus status) {
    ...
    if (status!=null){ this.status= new V1StatefulSetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1StatefulSetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1StatefulSetSpecFluentImpl<V1StatefulSetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1StatefulSetStatusFluentImpl<V1StatefulSetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
