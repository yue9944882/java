...
public interface V1PodDisruptionBudgetFluent<A extends V1PodDisruptionBudgetFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodDisruptionBudgetSpecFluent<V1PodDisruptionBudgetFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodDisruptionBudgetStatusFluent<V1PodDisruptionBudgetFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
