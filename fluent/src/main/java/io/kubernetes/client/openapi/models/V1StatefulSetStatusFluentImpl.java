...
import java.lang.Boolean;
  ...
  */
  ...
  public A addAllToConditions(Collection<io.kubernetes.client.openapi.models.V1StatefulSetCondition> items) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1StatefulSetConditionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1StatefulSetCondition item : items) {io.kubernetes.client.openapi.models.V1StatefulSetConditionBuilder builder = new io.kubernetes.client.openapi.models.V1StatefulSetConditionBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1StatefulSetConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1StatefulSetConditionFluentImpl<V1StatefulSetStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1StatefulSetStatusFluent.ConditionsNested<N>,Nested<N>{
