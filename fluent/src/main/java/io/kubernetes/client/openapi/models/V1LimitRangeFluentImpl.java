...
import java.lang.Boolean;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1LimitRangeSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1LimitRangeSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1LimitRangeFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1LimitRangeSpecFluentImpl<V1LimitRangeFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
