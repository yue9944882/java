...
public interface V1IngressSpecFluent<A extends V1IngressSpecFluent<A>> extends Fluent<A>{
  ...
  public interface RulesNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1IngressRuleFluent<V1IngressSpecFluent.RulesNested<N>>{
    public N and();
    public N endRule();
    
  }
  public interface TlsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1IngressTLSFluent<V1IngressSpecFluent.TlsNested<N>>{
    public N and();
    public N endTl();
