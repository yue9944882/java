...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1ResourceQuotaSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1ResourceQuotaSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ResourceQuotaFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ResourceQuotaSpecFluentImpl<V1ResourceQuotaFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ResourceQuotaStatusFluentImpl<V1ResourceQuotaFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ResourceQuotaFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
