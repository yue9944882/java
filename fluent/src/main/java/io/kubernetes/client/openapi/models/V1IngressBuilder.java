...
public class V1IngressBuilder extends V1IngressFluentImpl<V1IngressBuilder> implements VisitableBuilder<V1Ingress,io.kubernetes.client.openapi.models.V1IngressBuilder>{
