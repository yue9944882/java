...
public class V1SessionAffinityConfigBuilder extends V1SessionAffinityConfigFluentImpl<V1SessionAffinityConfigBuilder> implements VisitableBuilder<io.kubernetes.client.openapi.models.V1SessionAffinityConfig,V1SessionAffinityConfigBuilder>{
