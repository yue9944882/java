...
import java.lang.Object;
  ...
  */
  ...
  public A addToEgress(Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRule item) {
    if (this.egress == null) {this.egress = new java.util.ArrayList<V1NetworkPolicyEgressRuleBuilder>();}
  ...
  public A removeMatchingFromEgress(Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleBuilder> predicate) {
  ...
  public Boolean hasMatchingEgress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleBuilder> predicate) {
  ...
  public A addToIngress(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NetworkPolicyIngressRule item) {
    if (this.ingress == null) {this.ingress = new java.util.ArrayList<V1NetworkPolicyIngressRuleBuilder>();}
  ...
  class EgressNestedImpl<N> extends V1NetworkPolicyEgressRuleFluentImpl<V1NetworkPolicySpecFluent.EgressNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicySpecFluent.EgressNested<N>,Nested<N>{
  ...
  class IngressNestedImpl<N> extends V1NetworkPolicyIngressRuleFluentImpl<V1NetworkPolicySpecFluent.IngressNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicySpecFluent.IngressNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodSelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V1NetworkPolicySpecFluent.PodSelectorNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicySpecFluent.PodSelectorNested<N>,io.kubernetes.client.fluent.Nested<N>{
