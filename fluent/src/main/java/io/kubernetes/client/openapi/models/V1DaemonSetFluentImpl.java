...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1DaemonSetSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1DaemonSetSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1DaemonSetStatus status) {
    ...
    if (status!=null){ this.status= new V1DaemonSetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1DaemonSetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1DaemonSetSpecFluentImpl<V1DaemonSetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1DaemonSetStatusFluentImpl<V1DaemonSetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1DaemonSetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
