...
public class V1SecretBuilder extends V1SecretFluentImpl<V1SecretBuilder> implements VisitableBuilder<V1Secret,io.kubernetes.client.openapi.models.V1SecretBuilder>{
