...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V1ControllerRevision item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V1ControllerRevision> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1ControllerRevision item : items) {io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder builder = new io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1ControllerRevisionBuilder> predicate) {
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1ControllerRevisionListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ControllerRevisionListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
