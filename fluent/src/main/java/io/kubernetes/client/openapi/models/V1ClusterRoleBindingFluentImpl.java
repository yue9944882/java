...
import java.lang.Object;
  ...
  */
  ...
  public A withRoleRef(io.kubernetes.client.openapi.models.V1RoleRef roleRef) {
    ...
    if (roleRef!=null){ this.roleRef= new V1RoleRefBuilder(roleRef); _visitables.get("roleRef").add(this.roleRef);} return (A) this;
  }
  ...
  public A addToSubjects(Integer index,io.kubernetes.client.openapi.models.V1Subject item) {
    if (this.subjects == null) {this.subjects = new java.util.ArrayList<V1SubjectBuilder>();}
  ...
  public A removeMatchingFromSubjects(Predicate<io.kubernetes.client.openapi.models.V1SubjectBuilder> predicate) {
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ClusterRoleBindingFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleBindingFluent.MetadataNested<N>,Nested<N>{
  ...
  class RoleRefNestedImpl<N> extends V1RoleRefFluentImpl<V1ClusterRoleBindingFluent.RoleRefNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleBindingFluent.RoleRefNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SubjectsNestedImpl<N> extends V1SubjectFluentImpl<V1ClusterRoleBindingFluent.SubjectsNested<N>> implements io.kubernetes.client.openapi.models.V1ClusterRoleBindingFluent.SubjectsNested<N>,io.kubernetes.client.fluent.Nested<N>{
