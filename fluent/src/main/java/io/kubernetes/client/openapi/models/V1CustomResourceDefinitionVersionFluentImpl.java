...
import java.lang.Object;
  ...
  */
  ...
  public A addToAdditionalPrinterColumns(Integer index,io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item) {
    if (this.additionalPrinterColumns == null) {this.additionalPrinterColumns = new java.util.ArrayList<V1CustomResourceColumnDefinitionBuilder>();}
  ...
  public A addAllToAdditionalPrinterColumns(Collection<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition> items) {
    if (this.additionalPrinterColumns == null) {this.additionalPrinterColumns = new java.util.ArrayList<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder>();}
    for (io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition item : items) {io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder builder = new io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder(item);_visitables.get("additionalPrinterColumns").add(builder);this.additionalPrinterColumns.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromAdditionalPrinterColumns(Predicate<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinitionBuilder> predicate) {
   ...
   */
  @Deprecated
  public List<io.kubernetes.client.openapi.models.V1CustomResourceColumnDefinition> getAdditionalPrinterColumns() {
  ...
  public A withSchema(io.kubernetes.client.openapi.models.V1CustomResourceValidation schema) {
    ...
    if (schema!=null){ this.schema= new V1CustomResourceValidationBuilder(schema); _visitables.get("schema").add(this.schema);} return (A) this;
  }
  ...
  public A withSubresources(io.kubernetes.client.openapi.models.V1CustomResourceSubresources subresources) {
    ...
    if (subresources!=null){ this.subresources= new V1CustomResourceSubresourcesBuilder(subresources); _visitables.get("subresources").add(this.subresources);} return (A) this;
  }
  ...
  class AdditionalPrinterColumnsNestedImpl<N> extends V1CustomResourceColumnDefinitionFluentImpl<V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.AdditionalPrinterColumnsNested<N>,Nested<N>{
  ...
  class SchemaNestedImpl<N> extends V1CustomResourceValidationFluentImpl<V1CustomResourceDefinitionVersionFluent.SchemaNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SchemaNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SubresourcesNestedImpl<N> extends V1CustomResourceSubresourcesFluentImpl<V1CustomResourceDefinitionVersionFluent.SubresourcesNested<N>> implements io.kubernetes.client.openapi.models.V1CustomResourceDefinitionVersionFluent.SubresourcesNested<N>,io.kubernetes.client.fluent.Nested<N>{
