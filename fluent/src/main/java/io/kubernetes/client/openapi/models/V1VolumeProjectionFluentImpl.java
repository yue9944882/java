...
import java.lang.Object;
  ...
  */
  ...
  public A withSecret(io.kubernetes.client.openapi.models.V1SecretProjection secret) {
    ...
    if (secret!=null){ this.secret= new V1SecretProjectionBuilder(secret); _visitables.get("secret").add(this.secret);} return (A) this;
  }
  ...
  class ConfigMapNestedImpl<N> extends V1ConfigMapProjectionFluentImpl<V1VolumeProjectionFluent.ConfigMapNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeProjectionFluent.ConfigMapNested<N>,Nested<N>{
  ...
  class DownwardAPINestedImpl<N> extends V1DownwardAPIProjectionFluentImpl<V1VolumeProjectionFluent.DownwardAPINested<N>> implements io.kubernetes.client.openapi.models.V1VolumeProjectionFluent.DownwardAPINested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class SecretNestedImpl<N> extends V1SecretProjectionFluentImpl<V1VolumeProjectionFluent.SecretNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeProjectionFluent.SecretNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ServiceAccountTokenNestedImpl<N> extends V1ServiceAccountTokenProjectionFluentImpl<V1VolumeProjectionFluent.ServiceAccountTokenNested<N>> implements io.kubernetes.client.openapi.models.V1VolumeProjectionFluent.ServiceAccountTokenNested<N>,io.kubernetes.client.fluent.Nested<N>{
