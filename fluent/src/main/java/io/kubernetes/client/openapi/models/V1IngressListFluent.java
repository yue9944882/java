...
public interface V1IngressListFluent<A extends V1IngressListFluent<A>> extends Fluent<A>{
  ...
  public V1IngressListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1Ingress item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1IngressListFluent.MetadataNested<N>>{
    public N and();
