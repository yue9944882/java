...
import java.lang.Boolean;
  ...
  */
  ...
  public A withLimitResponse(io.kubernetes.client.openapi.models.V1beta1LimitResponse limitResponse) {
    ...
    if (limitResponse!=null){ this.limitResponse= new V1beta1LimitResponseBuilder(limitResponse); _visitables.get("limitResponse").add(this.limitResponse);} return (A) this;
  }
  ...
  class LimitResponseNestedImpl<N> extends V1beta1LimitResponseFluentImpl<V1beta1LimitedPriorityLevelConfigurationFluent.LimitResponseNested<N>> implements io.kubernetes.client.openapi.models.V1beta1LimitedPriorityLevelConfigurationFluent.LimitResponseNested<N>,Nested<N>{
