...
import java.util.Map;
  ...
  */
  ...
  class SecretRefNestedImpl<N> extends V1LocalObjectReferenceFluentImpl<V1FlexVolumeSourceFluent.SecretRefNested<N>> implements io.kubernetes.client.openapi.models.V1FlexVolumeSourceFluent.SecretRefNested<N>,Nested<N>{
