...
import java.lang.Object;
  ...
  */
  ...
  class ExecNestedImpl<N> extends V1ExecActionFluentImpl<V1ProbeFluent.ExecNested<N>> implements io.kubernetes.client.openapi.models.V1ProbeFluent.ExecNested<N>,Nested<N>{
  ...
  class GrpcNestedImpl<N> extends V1GRPCActionFluentImpl<V1ProbeFluent.GrpcNested<N>> implements io.kubernetes.client.openapi.models.V1ProbeFluent.GrpcNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class HttpGetNestedImpl<N> extends V1HTTPGetActionFluentImpl<V1ProbeFluent.HttpGetNested<N>> implements io.kubernetes.client.openapi.models.V1ProbeFluent.HttpGetNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TcpSocketNestedImpl<N> extends V1TCPSocketActionFluentImpl<V1ProbeFluent.TcpSocketNested<N>> implements io.kubernetes.client.openapi.models.V1ProbeFluent.TcpSocketNested<N>,io.kubernetes.client.fluent.Nested<N>{
