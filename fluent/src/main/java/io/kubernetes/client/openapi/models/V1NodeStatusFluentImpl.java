...
import java.lang.Integer;
  ...
  */
  ...
  private V1NodeStatus.PhaseEnum phase;
  ...
  public A removeMatchingFromAddresses(Predicate<io.kubernetes.client.openapi.models.V1NodeAddressBuilder> predicate) {
  ...
  public Boolean hasMatchingAddress(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NodeAddressBuilder> predicate) {
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1NodeCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<V1NodeConditionBuilder>();}
  ...
  public A addToVolumesAttached(java.lang.Integer index,io.kubernetes.client.openapi.models.V1AttachedVolume item) {
    if (this.volumesAttached == null) {this.volumesAttached = new java.util.ArrayList<V1AttachedVolumeBuilder>();}
  ...
  class AddressesNestedImpl<N> extends V1NodeAddressFluentImpl<V1NodeStatusFluent.AddressesNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.AddressesNested<N>,Nested<N>{
  ...
  class ConditionsNestedImpl<N> extends V1NodeConditionFluentImpl<V1NodeStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.ConditionsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ConfigNestedImpl<N> extends V1NodeConfigStatusFluentImpl<V1NodeStatusFluent.ConfigNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.ConfigNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class DaemonEndpointsNestedImpl<N> extends V1NodeDaemonEndpointsFluentImpl<V1NodeStatusFluent.DaemonEndpointsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.DaemonEndpointsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ImagesNestedImpl<N> extends V1ContainerImageFluentImpl<V1NodeStatusFluent.ImagesNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.ImagesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class NodeInfoNestedImpl<N> extends V1NodeSystemInfoFluentImpl<V1NodeStatusFluent.NodeInfoNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.NodeInfoNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class VolumesAttachedNestedImpl<N> extends V1AttachedVolumeFluentImpl<V1NodeStatusFluent.VolumesAttachedNested<N>> implements io.kubernetes.client.openapi.models.V1NodeStatusFluent.VolumesAttachedNested<N>,io.kubernetes.client.fluent.Nested<N>{
