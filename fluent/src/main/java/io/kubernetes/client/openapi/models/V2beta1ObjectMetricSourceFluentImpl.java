...
import java.lang.Boolean;
  ...
  */
  ...
  public V2beta1ObjectMetricSourceFluent.SelectorNested<A> withNewSelector() {
    return new V2beta1ObjectMetricSourceFluentImpl.SelectorNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.SelectorNested<A> withNewSelectorLike(io.kubernetes.client.openapi.models.V1LabelSelector item) {
    return new V2beta1ObjectMetricSourceFluentImpl.SelectorNestedImpl(item);
  }
  ...
  public V2beta1ObjectMetricSourceFluent.TargetNested<A> withNewTarget() {
    return new V2beta1ObjectMetricSourceFluentImpl.TargetNestedImpl();
  }
  ...
  class SelectorNestedImpl<N> extends V1LabelSelectorFluentImpl<V2beta1ObjectMetricSourceFluent.SelectorNested<N>> implements io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.SelectorNested<N>,Nested<N>{
  ...
  class TargetNestedImpl<N> extends V2beta1CrossVersionObjectReferenceFluentImpl<V2beta1ObjectMetricSourceFluent.TargetNested<N>> implements io.kubernetes.client.openapi.models.V2beta1ObjectMetricSourceFluent.TargetNested<N>,io.kubernetes.client.fluent.Nested<N>{
