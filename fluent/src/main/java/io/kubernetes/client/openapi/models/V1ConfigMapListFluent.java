...
public interface V1ConfigMapListFluent<A extends V1ConfigMapListFluent<A>> extends Fluent<A>{
  ...
  public V1ConfigMapListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1ConfigMap item);
  ...
  public interface MetadataNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ListMetaFluent<V1ConfigMapListFluent.MetadataNested<N>>{
    public N and();
