...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromEndpoints(Predicate<io.kubernetes.client.openapi.models.V1EndpointBuilder> predicate) {
  ...
  public A addToPorts(java.lang.Integer index,io.kubernetes.client.openapi.models.DiscoveryV1EndpointPort item) {
    if (this.ports == null) {this.ports = new java.util.ArrayList<DiscoveryV1EndpointPortBuilder>();}
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1EndpointSliceFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PortsNestedImpl<N> extends DiscoveryV1EndpointPortFluentImpl<V1EndpointSliceFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1EndpointSliceFluent.PortsNested<N>,io.kubernetes.client.fluent.Nested<N>{
