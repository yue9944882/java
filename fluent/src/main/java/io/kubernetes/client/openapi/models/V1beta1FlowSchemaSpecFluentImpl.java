...
import java.lang.Object;
  ...
  */
  ...
  public A addToRules(java.lang.Integer index,io.kubernetes.client.openapi.models.V1beta1PolicyRulesWithSubjects item) {
    if (this.rules == null) {this.rules = new java.util.ArrayList<V1beta1PolicyRulesWithSubjectsBuilder>();}
  ...
  public A removeMatchingFromRules(Predicate<io.kubernetes.client.openapi.models.V1beta1PolicyRulesWithSubjectsBuilder> predicate) {
  ...
  class DistinguisherMethodNestedImpl<N> extends V1beta1FlowDistinguisherMethodFluentImpl<V1beta1FlowSchemaSpecFluent.DistinguisherMethodNested<N>> implements io.kubernetes.client.openapi.models.V1beta1FlowSchemaSpecFluent.DistinguisherMethodNested<N>,Nested<N>{
  ...
  class RulesNestedImpl<N> extends V1beta1PolicyRulesWithSubjectsFluentImpl<V1beta1FlowSchemaSpecFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1beta1FlowSchemaSpecFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
