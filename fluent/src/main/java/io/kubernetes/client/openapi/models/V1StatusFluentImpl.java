...
import java.lang.Boolean;
  ...
  */
  ...
  class DetailsNestedImpl<N> extends V1StatusDetailsFluentImpl<V1StatusFluent.DetailsNested<N>> implements io.kubernetes.client.openapi.models.V1StatusFluent.DetailsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1StatusFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1StatusFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
