...
import java.lang.Object;
  ...
  */
  ...
  public A addToRules(Integer index,io.kubernetes.client.openapi.models.V1IngressRule item) {
    if (this.rules == null) {this.rules = new java.util.ArrayList<V1IngressRuleBuilder>();}
  ...
  public A removeMatchingFromRules(Predicate<io.kubernetes.client.openapi.models.V1IngressRuleBuilder> predicate) {
  ...
  public A addToTls(java.lang.Integer index,io.kubernetes.client.openapi.models.V1IngressTLS item) {
    if (this.tls == null) {this.tls = new java.util.ArrayList<V1IngressTLSBuilder>();}
  ...
  class DefaultBackendNestedImpl<N> extends V1IngressBackendFluentImpl<V1IngressSpecFluent.DefaultBackendNested<N>> implements io.kubernetes.client.openapi.models.V1IngressSpecFluent.DefaultBackendNested<N>,Nested<N>{
  ...
  class RulesNestedImpl<N> extends V1IngressRuleFluentImpl<V1IngressSpecFluent.RulesNested<N>> implements io.kubernetes.client.openapi.models.V1IngressSpecFluent.RulesNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class TlsNestedImpl<N> extends V1IngressTLSFluentImpl<V1IngressSpecFluent.TlsNested<N>> implements io.kubernetes.client.openapi.models.V1IngressSpecFluent.TlsNested<N>,io.kubernetes.client.fluent.Nested<N>{
