...
import java.lang.Boolean;
  ...
  */
  ...
  public A withValueFrom(io.kubernetes.client.openapi.models.V1EnvVarSource valueFrom) {
    ...
    if (valueFrom!=null){ this.valueFrom= new V1EnvVarSourceBuilder(valueFrom); _visitables.get("valueFrom").add(this.valueFrom);} return (A) this;
  }
  ...
  class ValueFromNestedImpl<N> extends V1EnvVarSourceFluentImpl<V1EnvVarFluent.ValueFromNested<N>> implements io.kubernetes.client.openapi.models.V1EnvVarFluent.ValueFromNested<N>,Nested<N>{
