...
public interface V1ScaleFluent<A extends V1ScaleFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ScaleSpecFluent<V1ScaleFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1ScaleStatusFluent<V1ScaleFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
