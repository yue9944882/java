...
import java.lang.Object;
  ...
  */
  ...
  public class V1beta1PodDisruptionBudgetFluentImpl<A extends V1beta1PodDisruptionBudgetFluent<A>> extends BaseFluent<A> implements V1beta1PodDisruptionBudgetFluent<A>{
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1beta1PodDisruptionBudgetSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  public A withStatus(io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatus status) {
    ...
    if (status!=null){ this.status= new V1beta1PodDisruptionBudgetStatusBuilder(status); _visitables.get("status").add(this.status);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1beta1PodDisruptionBudgetFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1beta1PodDisruptionBudgetSpecFluentImpl<V1beta1PodDisruptionBudgetFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1beta1PodDisruptionBudgetStatusFluentImpl<V1beta1PodDisruptionBudgetFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
