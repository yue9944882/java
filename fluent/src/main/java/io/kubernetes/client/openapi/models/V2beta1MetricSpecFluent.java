...
public interface V2beta1MetricSpecFluent<A extends V2beta1MetricSpecFluent<A>> extends Fluent<A>{
  ...
  public interface ContainerResourceNested<N> extends Nested<N>,V2beta1ContainerResourceMetricSourceFluent<V2beta1MetricSpecFluent.ContainerResourceNested<N>>{
    public N and();
    public N endContainerResource();
    
  }
  public interface ExternalNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ExternalMetricSourceFluent<V2beta1MetricSpecFluent.ExternalNested<N>>{
    public N and();
    public N endExternal();
    
  }
  public interface ObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ObjectMetricSourceFluent<V2beta1MetricSpecFluent.ObjectNested<N>>{
    public N and();
    public N endObject();
    
  }
  public interface PodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1PodsMetricSourceFluent<V2beta1MetricSpecFluent.PodsNested<N>>{
    public N and();
    public N endPods();
    
  }
  public interface ResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta1ResourceMetricSourceFluent<V2beta1MetricSpecFluent.ResourceNested<N>>{
    public N and();
