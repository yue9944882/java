...
import java.lang.Object;
  ...
  */
  ...
  public A addToItems(Integer index,io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item) {
  ...
  public A addAllToItems(Collection<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler> items) {
    if (this.items == null) {this.items = new java.util.ArrayList<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBuilder>();}
    for (io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler item : items) {io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBuilder builder = new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBuilder(item);_visitables.get("items").add(builder);this.items.add(builder);} return (A)this;
  }
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBuilder> predicate) {
  ...
  class ItemsNestedImpl<N> extends V2beta2HorizontalPodAutoscalerFluentImpl<V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V2beta2HorizontalPodAutoscalerListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
