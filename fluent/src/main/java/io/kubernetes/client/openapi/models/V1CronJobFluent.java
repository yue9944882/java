...
public interface V1CronJobFluent<A extends V1CronJobFluent<A>> extends Fluent<A>{
  ...
  public interface SpecNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CronJobSpecFluent<V1CronJobFluent.SpecNested<N>>{
    public N and();
    public N endSpec();
    
  }
  public interface StatusNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1CronJobStatusFluent<V1CronJobFluent.StatusNested<N>>{
    public N and();
    public N endStatus();
