...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromPorts(Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPortBuilder> predicate) {
  ...
  public Boolean hasMatchingPort(java.util.function.Predicate<io.kubernetes.client.openapi.models.V1NetworkPolicyPortBuilder> predicate) {
  ...
  class PortsNestedImpl<N> extends V1NetworkPolicyPortFluentImpl<V1NetworkPolicyEgressRuleFluent.PortsNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.PortsNested<N>,Nested<N>{
  ...
  class ToNestedImpl<N> extends V1NetworkPolicyPeerFluentImpl<V1NetworkPolicyEgressRuleFluent.ToNested<N>> implements io.kubernetes.client.openapi.models.V1NetworkPolicyEgressRuleFluent.ToNested<N>,io.kubernetes.client.fluent.Nested<N>{
