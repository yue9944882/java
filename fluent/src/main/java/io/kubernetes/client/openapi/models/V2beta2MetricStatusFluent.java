...
public interface V2beta2MetricStatusFluent<A extends V2beta2MetricStatusFluent<A>> extends Fluent<A>{
  ...
  public interface ExternalNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2ExternalMetricStatusFluent<V2beta2MetricStatusFluent.ExternalNested<N>>{
    public N and();
    public N endExternal();
    
  }
  public interface ObjectNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2ObjectMetricStatusFluent<V2beta2MetricStatusFluent.ObjectNested<N>>{
    public N and();
    public N endObject();
    
  }
  public interface PodsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2PodsMetricStatusFluent<V2beta2MetricStatusFluent.PodsNested<N>>{
    public N and();
    public N endPods();
    
  }
  public interface ResourceNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2beta2ResourceMetricStatusFluent<V2beta2MetricStatusFluent.ResourceNested<N>>{
    public N and();
