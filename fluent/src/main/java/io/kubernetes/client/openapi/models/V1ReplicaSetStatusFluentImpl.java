...
import java.lang.Boolean;
  ...
  */
  ...
  public A addToConditions(java.lang.Integer index,io.kubernetes.client.openapi.models.V1ReplicaSetCondition item) {
    if (this.conditions == null) {this.conditions = new java.util.ArrayList<V1ReplicaSetConditionBuilder>();}
  ...
  public A removeMatchingFromConditions(Predicate<io.kubernetes.client.openapi.models.V1ReplicaSetConditionBuilder> predicate) {
  ...
  class ConditionsNestedImpl<N> extends V1ReplicaSetConditionFluentImpl<V1ReplicaSetStatusFluent.ConditionsNested<N>> implements io.kubernetes.client.openapi.models.V1ReplicaSetStatusFluent.ConditionsNested<N>,Nested<N>{
