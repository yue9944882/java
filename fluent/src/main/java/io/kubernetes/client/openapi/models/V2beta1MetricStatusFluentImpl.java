...
import java.lang.Object;
  ...
  */
  ...
  public V2beta1MetricStatusFluent.ContainerResourceNested<A> withNewContainerResource() {
    return new V2beta1MetricStatusFluentImpl.ContainerResourceNestedImpl();
  }
  public io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.ContainerResourceNested<A> withNewContainerResourceLike(io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricStatus item) {
    return new V2beta1MetricStatusFluentImpl.ContainerResourceNestedImpl(item);
  }
  ...
  public V2beta1MetricStatusFluent.ExternalNested<A> withNewExternal() {
    return new V2beta1MetricStatusFluentImpl.ExternalNestedImpl();
  }
  ...
  public V2beta1MetricStatusFluent.ObjectNested<A> withNewObject() {
    return new V2beta1MetricStatusFluentImpl.ObjectNestedImpl();
  }
  ...
  public V2beta1MetricStatusFluent.PodsNested<A> withNewPods() {
    return new V2beta1MetricStatusFluentImpl.PodsNestedImpl();
  }
  ...
  public V2beta1MetricStatusFluent.ResourceNested<A> withNewResource() {
    return new V2beta1MetricStatusFluentImpl.ResourceNestedImpl();
  }
  ...
  class ContainerResourceNestedImpl<N> extends V2beta1ContainerResourceMetricStatusFluentImpl<V2beta1MetricStatusFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2beta1ExternalMetricStatusFluentImpl<V2beta1MetricStatusFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2beta1ObjectMetricStatusFluentImpl<V2beta1MetricStatusFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2beta1PodsMetricStatusFluentImpl<V2beta1MetricStatusFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2beta1ResourceMetricStatusFluentImpl<V2beta1MetricStatusFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta1MetricStatusFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
