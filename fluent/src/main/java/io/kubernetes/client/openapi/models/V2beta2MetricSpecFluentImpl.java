...
import java.lang.Object;
  ...
  */
  ...
  public A withContainerResource(io.kubernetes.client.openapi.models.V2beta2ContainerResourceMetricSource containerResource) {
    ...
    if (containerResource!=null){ this.containerResource= new V2beta2ContainerResourceMetricSourceBuilder(containerResource); _visitables.get("containerResource").add(this.containerResource);} return (A) this;
  }
  ...
  public A withExternal(io.kubernetes.client.openapi.models.V2beta2ExternalMetricSource external) {
    ...
    if (external!=null){ this.external= new V2beta2ExternalMetricSourceBuilder(external); _visitables.get("external").add(this.external);} return (A) this;
  }
  ...
  public A withObject(io.kubernetes.client.openapi.models.V2beta2ObjectMetricSource _object) {
    ...
    if (_object!=null){ this._object= new V2beta2ObjectMetricSourceBuilder(_object); _visitables.get("_object").add(this._object);} return (A) this;
  }
  ...
  public A withPods(io.kubernetes.client.openapi.models.V2beta2PodsMetricSource pods) {
    ...
    if (pods!=null){ this.pods= new V2beta2PodsMetricSourceBuilder(pods); _visitables.get("pods").add(this.pods);} return (A) this;
  }
  ...
  public A withResource(io.kubernetes.client.openapi.models.V2beta2ResourceMetricSource resource) {
    ...
    if (resource!=null){ this.resource= new V2beta2ResourceMetricSourceBuilder(resource); _visitables.get("resource").add(this.resource);} return (A) this;
  }
  ...
  class ContainerResourceNestedImpl<N> extends V2beta2ContainerResourceMetricSourceFluentImpl<V2beta2MetricSpecFluent.ContainerResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricSpecFluent.ContainerResourceNested<N>,Nested<N>{
  ...
  class ExternalNestedImpl<N> extends V2beta2ExternalMetricSourceFluentImpl<V2beta2MetricSpecFluent.ExternalNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricSpecFluent.ExternalNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ObjectNestedImpl<N> extends V2beta2ObjectMetricSourceFluentImpl<V2beta2MetricSpecFluent.ObjectNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricSpecFluent.ObjectNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class PodsNestedImpl<N> extends V2beta2PodsMetricSourceFluentImpl<V2beta2MetricSpecFluent.PodsNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricSpecFluent.PodsNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class ResourceNestedImpl<N> extends V2beta2ResourceMetricSourceFluentImpl<V2beta2MetricSpecFluent.ResourceNested<N>> implements io.kubernetes.client.openapi.models.V2beta2MetricSpecFluent.ResourceNested<N>,io.kubernetes.client.fluent.Nested<N>{
