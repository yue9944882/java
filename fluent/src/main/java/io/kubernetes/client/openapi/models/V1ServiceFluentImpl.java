...
import java.lang.Object;
  ...
  */
  ...
  public A withSpec(io.kubernetes.client.openapi.models.V1ServiceSpec spec) {
    ...
    if (spec!=null){ this.spec= new V1ServiceSpecBuilder(spec); _visitables.get("spec").add(this.spec);} return (A) this;
  }
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1ServiceFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1ServiceSpecFluentImpl<V1ServiceFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
  ...
  class StatusNestedImpl<N> extends V1ServiceStatusFluentImpl<V1ServiceFluent.StatusNested<N>> implements io.kubernetes.client.openapi.models.V1ServiceFluent.StatusNested<N>,io.kubernetes.client.fluent.Nested<N>{
