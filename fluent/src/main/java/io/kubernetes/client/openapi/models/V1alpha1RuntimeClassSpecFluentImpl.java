...
import java.lang.Boolean;
  ...
  */
  ...
  class OverheadNestedImpl<N> extends V1alpha1OverheadFluentImpl<V1alpha1RuntimeClassSpecFluent.OverheadNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecFluent.OverheadNested<N>,Nested<N>{
  ...
  class SchedulingNestedImpl<N> extends V1alpha1SchedulingFluentImpl<V1alpha1RuntimeClassSpecFluent.SchedulingNested<N>> implements io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpecFluent.SchedulingNested<N>,io.kubernetes.client.fluent.Nested<N>{
