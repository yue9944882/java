...
public interface V1CSIPersistentVolumeSourceFluent<A extends V1CSIPersistentVolumeSourceFluent<A>> extends Fluent<A>{
  ...
  public interface ControllerPublishSecretRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SecretReferenceFluent<V1CSIPersistentVolumeSourceFluent.ControllerPublishSecretRefNested<N>>{
    public N and();
    public N endControllerPublishSecretRef();
    
  }
  public interface NodePublishSecretRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SecretReferenceFluent<V1CSIPersistentVolumeSourceFluent.NodePublishSecretRefNested<N>>{
    public N and();
    public N endNodePublishSecretRef();
    
  }
  public interface NodeStageSecretRefNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1SecretReferenceFluent<V1CSIPersistentVolumeSourceFluent.NodeStageSecretRefNested<N>>{
    public N and();
