...
public interface V2HorizontalPodAutoscalerStatusFluent<A extends V2HorizontalPodAutoscalerStatusFluent<A>> extends Fluent<A>{
  ...
  public A addToCurrentMetrics(java.lang.Integer index,V2MetricStatus item);
  ...
  public A removeMatchingFromCurrentMetrics(java.util.function.Predicate<V2MetricStatusBuilder> predicate);
  ...
  public interface CurrentMetricsNested<N> extends io.kubernetes.client.fluent.Nested<N>,V2MetricStatusFluent<V2HorizontalPodAutoscalerStatusFluent.CurrentMetricsNested<N>>{
    public N and();
