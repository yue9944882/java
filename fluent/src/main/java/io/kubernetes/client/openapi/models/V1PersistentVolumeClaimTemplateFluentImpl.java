...
import java.lang.Boolean;
  ...
  */
  ...
  class MetadataNestedImpl<N> extends V1ObjectMetaFluentImpl<V1PersistentVolumeClaimTemplateFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.MetadataNested<N>,Nested<N>{
  ...
  class SpecNestedImpl<N> extends V1PersistentVolumeClaimSpecFluentImpl<V1PersistentVolumeClaimTemplateFluent.SpecNested<N>> implements io.kubernetes.client.openapi.models.V1PersistentVolumeClaimTemplateFluent.SpecNested<N>,io.kubernetes.client.fluent.Nested<N>{
