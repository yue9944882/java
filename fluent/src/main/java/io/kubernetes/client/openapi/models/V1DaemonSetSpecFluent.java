...
public interface V1DaemonSetSpecFluent<A extends V1DaemonSetSpecFluent<A>> extends Fluent<A>{
  ...
  public interface TemplateNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1PodTemplateSpecFluent<V1DaemonSetSpecFluent.TemplateNested<N>>{
    public N and();
    public N endTemplate();
    
  }
  public interface UpdateStrategyNested<N> extends io.kubernetes.client.fluent.Nested<N>,V1DaemonSetUpdateStrategyFluent<V1DaemonSetSpecFluent.UpdateStrategyNested<N>>{
    public N and();
