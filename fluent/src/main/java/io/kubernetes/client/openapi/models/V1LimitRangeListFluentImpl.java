...
import java.lang.Object;
  ...
  */
  ...
  public A removeMatchingFromItems(Predicate<io.kubernetes.client.openapi.models.V1LimitRangeBuilder> predicate) {
  ...
  public V1LimitRangeListFluent.ItemsNested<A> addNewItemLike(io.kubernetes.client.openapi.models.V1LimitRange item) {
  ...
  class ItemsNestedImpl<N> extends V1LimitRangeFluentImpl<V1LimitRangeListFluent.ItemsNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeListFluent.ItemsNested<N>,Nested<N>{
  ...
  class MetadataNestedImpl<N> extends V1ListMetaFluentImpl<V1LimitRangeListFluent.MetadataNested<N>> implements io.kubernetes.client.openapi.models.V1LimitRangeListFluent.MetadataNested<N>,io.kubernetes.client.fluent.Nested<N>{
