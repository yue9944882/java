...
import java.lang.Object;
  ...
  */
  ...
  public A addToTaints(java.lang.Integer index,io.kubernetes.client.openapi.models.V1Taint item) {
    if (this.taints == null) {this.taints = new java.util.ArrayList<V1TaintBuilder>();}
  ...
  class ConfigSourceNestedImpl<N> extends V1NodeConfigSourceFluentImpl<V1NodeSpecFluent.ConfigSourceNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSpecFluent.ConfigSourceNested<N>,Nested<N>{
  ...
  class TaintsNestedImpl<N> extends V1TaintFluentImpl<V1NodeSpecFluent.TaintsNested<N>> implements io.kubernetes.client.openapi.models.V1NodeSpecFluent.TaintsNested<N>,io.kubernetes.client.fluent.Nested<N>{
