...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("Kubernetes Java Client/[ERROR] Failed to execute goal org.codehaus.mojo:exec-maven-plugin:1.6.0:exec (default-cli): Goal requires a project to execute but there is no POM in this directory (/home/runner/work/java/java/gen/openapi). Please verify you invoked Maven from the correct directory. -> [Help 1]
[ERROR] 
